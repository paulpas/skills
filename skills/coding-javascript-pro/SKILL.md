---
name: javascript-pro
description: "\"Provides Master modern JavaScript with ES6+, async patterns, and Node.js APIs. Handles promises, event loops, and browser/Node compatibility\""
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: javascript pro, code, implementation guide
---
...
- When master modern javascript with es6+, async patterns...
