---
name: cncf-kuma
description: "\"Kuma in Service Mesh - cloud native architecture, patterns, pitfalls\" and best practices"
license: MIT
...
metadata:
  ...
  triggers: cdn, infrastructure as code, k8s service, kubernetes service, kuma, monitoring,
    native, service
  related-skills: cncf-calico, cncf-cilium, cncf-contour, cncf-linkerd
---
...
**Primary Language:** Go  
**Documentation:** [https://github.com/kumahq/kuma](https://github.com/kumahq/kuma)  

---

## Purpose and Use Cases

Kuma is a cloud-native project that provides service-mesh functionality for modern distributed systems.

### What Problem Does It Solve?

Kuma addresses the challenges of service-mesh in cloud-native environments, enabling teams to implement service-mesh features without embedding them in application code.

### When to Use This Project

Use kuma when you need service-mesh capabilities in your Kubernetes or cloud-native infrastructure. It's ideal when you require service-mesh with minimal application code changes.
...
- service-mesh with declarative configuration
- service-mesh for observability and monitoring
- service-mesh for security and compliance
