...
- examples
- do-dont
description: Implements intelligent parallel skill runner with multi-factor skill selection, fallback chains, and adherence
...
metadata:
  ...
  role: orchestration
  scope: orchestration
  triggers: parallel-skill-runner, parallel skill runner, how do i parallel-skill-runner, orchestrate parallel-skill-runner,
    automate parallel-skill-runner, agent parallel-skill-runner
  version: 1.0.0
