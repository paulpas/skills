---
name: recallmax
description: '"Provides FREE — God-tier long-context memory for AI agents. Injects  500K-1M
  clean tokens, auto-summarizes with tone/intent preservation, compresses  14-turn
  his"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: recallmax, memory, implementation guide
---
...
- When free — god-tier long-context memory for ai agents....
