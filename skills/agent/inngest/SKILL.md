---
name: inngest
description: '"Provides Inngest expert for serverless-first background jobs, event-driven
...
metadata:
  ...
  output-format: code
  triggers: inngest, workflow, implementation guide
---
...
- When inngest expert for serverless-first background job...
