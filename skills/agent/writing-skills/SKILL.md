---
name: skills
description: '"Implements use when creating, updating, or improving agent skills for
...
metadata:
  ...
  output-format: code
  triggers: writing skills, meta, implementation guide
---
...
- When use when creating, updating, or improving agent sk...
