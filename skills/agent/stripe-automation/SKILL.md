---
name: automation
description: '''Provides Automate Stripe tasks via Rube MCP (Composio): customers,
  charges, subscriptions, invoices, products, refunds. Always search tools first for
  current s'''
license: MIT
...
- When automate stripe tasks via rube mcp (composio): cus...
