---
name: seekers
description: '"Provides -Automatically convert documentation websites, GitHub repositories,
  and PDFs into Claude AI skills in minutes"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: skill seekers, meta, how do i automate
---
...
- When -automatically convert documentation websites, git...
