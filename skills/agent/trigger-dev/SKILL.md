---
name: dev
description: '"Provides Trigger.dev expert for background jobs, AI workflows, and
  reliable async execution with excellent developer experience and TypeScript-first
  design"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: trigger dev, workflow, implementation guide
---
...
- When trigger.dev expert for background jobs, ai workflo...
