---
name: lang
description: Provides Native agent-to-agent language for compact multi-agent messaging.
  A shared tongue agents speak directly, not a translation layer. 340+ atoms across
  7
license: MIT
...
- When native agent-to-agent language for compact multi-a...
