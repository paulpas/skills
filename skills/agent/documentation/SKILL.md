---
name: documentation
description: '"Provides Documentation generation workflow covering API docs, architecture
...
metadata:
  ...
  output-format: code
  triggers: documentation, workflow, bundle, implementation guide
---
...
- When documentation generation workflow covering api doc...
