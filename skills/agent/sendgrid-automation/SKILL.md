---
name: automation
description: Provides Automate SendGrid email delivery workflows including marketing
  campaigns (Single Sends), contact and list management, sender identity setup, and
  email
license: MIT
...
- When automate sendgrid email delivery workflows includi...
