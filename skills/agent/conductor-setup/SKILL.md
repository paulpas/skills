---
name: setup
description: '"Provides Configure a Rails project to work with Conductor (parallel
  coding agents)"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: conductor setup, workflow, implementation guide
---
...
- When configure a rails project to work with conductor (...
