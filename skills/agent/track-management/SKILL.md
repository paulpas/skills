---
name: management
description: '"Provides use this skill when creating, managing, or working with conductor
  tracks - the logical work units for features, bugs, and refactors. applies to spec.m"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: track management, planning, implementation guide
---
...
- When use this skill when creating, managing, or working...
