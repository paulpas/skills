---
name: status
description: '"Implements display project status, active tracks, and next actions
...
metadata:
  ...
  output-format: code
  triggers: conductor status, workflow, implementation guide
---
...
- When display project status, active tracks, and next ac...
