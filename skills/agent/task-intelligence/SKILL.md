---
name: intelligence
description: '"Provides Protocolo de Inteligência Pré-Tarefa — ativa TODOS  os agentes
  relevantes do ecossistema ANTES de executar qualquer tarefa solicitada  pelo usuário"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: task intelligence, workflow, implementation guide
---
...
- When protocolo de inteligência pré-tarefa — ativa todos...
