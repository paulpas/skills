---
name: automation
description: '''Provides Automate CircleCI tasks via Rube MCP (Composio): trigger
  pipelines, monitor workflows/jobs, retrieve artifacts and test metadata. Always
  search tools'''
license: MIT
...
- When automate circleci tasks via rube mcp (composio): t...
