---
name: advisor
description: '"Provides Conselho de especialistas — consulta multiplos agentes  do
  ecossistema em paralelo para analise multi-perspectiva de qualquer topico.  Ativa
  personas, e"'
license: MIT
...
- When conselho de especialistas — consulta multiplos age...
