---
name: agents
description: Provides Multi-agent orchestration patterns. Use when multiple independent
  tasks can run with different domain expertise or when comprehensive analysis require
license: MIT
...
- When multi-agent orchestration patterns. use when multi...
