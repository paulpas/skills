---
name: revert
description: '"Implements git-aware undo by logical work unit (track, phase, or task)
...
metadata:
  ...
  output-format: code
  triggers: conductor revert, workflow, implementation guide
---
...
- When git-aware undo by logical work unit (track, phase,...
