---
name: automation
description: '''Provides Automate HelpDesk tasks via Rube MCP (Composio): list tickets,
  manage views, use canned responses, and configure custom fields. Always search tools
  fi'''
license: MIT
...
- When automate helpdesk tasks via rube mcp (composio): l...
