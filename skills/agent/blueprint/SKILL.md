---
name: blueprint
description: '"Provides Turn a one-line objective into a step-by-step construction  plan
  any coding agent can execute cold. Each step has a self-contained context  brief
  — a fr"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: blueprint, planning, implementation guide
---
...
- When turn a one-line objective into a step-by-step cons...
