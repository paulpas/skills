---
name: optimizer
description: Provides Diagnose and optimize Agent Skills (SKILL.md) with real session
  data and research-backed static analysis. Works with Claude Code, Codex, and any
  Agent
license: MIT
...
- When diagnose and optimize agent skills (skill.md) with...
