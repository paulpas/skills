---
name: automation
description: '''Provides Automate Outlook tasks via Rube MCP (Composio): emails, calendar,
  contacts, folders, attachments. Always search tools first for current schemas'''
license: MIT
...
- When automate outlook tasks via rube mcp (composio): em...
