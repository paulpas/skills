---
name: pushing
description: '"Provides Stage all changes, create a conventional commit, and push
  to the remote branch. Use when explicitly asks to push changes ("'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: git pushing, workflow, implementation guide
---
...
- When stage all changes, create a conventional commit, a...
