...
- examples
- do-dont
description: Implements intelligent conductor manage with multi-factor skill selection, fallback chains, and adherence to
...
metadata:
  ...
  role: orchestration
  scope: orchestration
  triggers: conductor-manage, conductor manage, how do i conductor-manage, orchestrate conductor-manage, automate conductor-manage,
    agent conductor-manage
  version: 1.0.0
