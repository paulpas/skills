---
name: plans
description: '"Provides use when you have a written implementation plan to execute
...
metadata:
  ...
  output-format: code
  triggers: executing plans, workflow, implementation guide
---
...
- When use when you have a written implementation plan to...
