---
name: planning
description: '"Provides use when a user asks for a plan for a coding task, to generate
  a clear, actionable, and atomic checklist"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: concise planning, planning, implementation guide
---
...
- When use when a user asks for a plan for a coding task,...
