---
name: systems
description: '"Provides Design short-term, long-term, and graph-based memory architectures.
  Use when building agents that must persist across sessions, needing to maintain
  en"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: memory systems, memory, implementation guide
---
...
- When design short-term, long-term, and graph-based memo...
