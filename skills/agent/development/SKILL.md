---
name: development
description: '"Provides Comprehensive web, mobile, and backend development workflow
  bundling frontend, backend, full-stack, and mobile development skills for end-to-end
  appli"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: development, workflow, bundle, implementation guide
---
...
- When comprehensive web, mobile, and backend development...
