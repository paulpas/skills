...
- examples
- do-dont
description: Implements intelligent closed loop delivery with multi-factor skill selection, fallback chains, and adherence
...
metadata:
  ...
  role: orchestration
  scope: orchestration
  triggers: closed-loop-delivery, closed loop delivery, how do i closed-loop-delivery, orchestrate closed-loop-delivery, automate
