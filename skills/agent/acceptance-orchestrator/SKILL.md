---
name: orchestrator
description: '"Provides use when a coding task should be driven end-to-end from issue
  intake through implementation, review, deployment, and acceptance verification with
  mini"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: acceptance orchestrator, workflow, how do i deploy
---
...
- When use when a coding task should be driven end-to-end...
