---
name: automation
description: '"Provides Automate changelog generation from commits, PRs, and releases
  following Keep a Changelog format. Use when setting up release workflows, generating
  rel"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: changelog automation, workflow, how do i automate
---
...
- When automate changelog generation from commits, prs, a...
