---
name: automation
description: Provides Automate Freshdesk helpdesk operations including tickets, contacts,
  companies, notes, and replies via Rube MCP (Composio). Always search tools first
  f
license: MIT
...
- When automate freshdesk helpdesk operations including t...
