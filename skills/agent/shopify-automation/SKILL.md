---
name: automation
description: '''Provides Automate Shopify tasks via Rube MCP (Composio): products,
  orders, customers, inventory, collections. Always search tools first for current
  schemas'''
license: MIT
