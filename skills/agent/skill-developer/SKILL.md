---
name: developer
description: '"Provides Comprehensive guide for creating and managing skills in Claude
  Code with auto-activation system, following Anthropic''s official best practices
  includi"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: skill developer, meta, implementation guide
---
...
- When comprehensive guide for creating and managing skil...
