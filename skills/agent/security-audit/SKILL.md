---
name: audit
description: Provides Comprehensive security auditing workflow covering web application
  testing, API security, penetration testing, vulnerability scanning, and security
  har
license: MIT
...
- When comprehensive security auditing workflow covering ...
