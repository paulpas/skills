---
name: automation
description: Provides Automate HubSpot CRM operations (contacts, companies, deals,
  tickets, properties) via Rube MCP using Composio integration
license: MIT
...
- When automate hubspot crm operations (contacts, compani...
