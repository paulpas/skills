---
name: superpowers
description: '"Provides use when starting any conversation - establishes how to find
  and use skills, requiring skill tool invocation before any response including clarifying"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: using superpowers, meta, implementation guide
---
...
- When use when starting any conversation - establishes h...
