---
name: writer
description: '"Provides Create and improve agent skills following the Agent Skills
  specification. Use when asked to create, write, or update skills"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: skill writer, meta, implementation guide
---
...
- When create and improve agent skills following the agen...
