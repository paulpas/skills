---
name: automation
description: Provides Automate ClickUp project management including tasks, spaces,
  folders, lists, comments, and team operations via Rube MCP (Composio). Always search
  tool
license: MIT
...
- When automate clickup project management including task...
