---
name: devops
description: '"Provides Cloud infrastructure and DevOps workflow covering AWS, Azure,
  GCP, Kubernetes, Terraform, CI/CD, monitoring, and cloud-native development"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: cloud devops, workflow, bundle, implementation guide
---
...
- When cloud infrastructure and devops workflow covering ...
