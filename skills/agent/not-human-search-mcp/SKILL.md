...
- examples
- do-dont
description: Implements intelligent not human search mcp with multi-factor skill selection, fallback chains, and adherence
...
metadata:
  ...
  role: orchestration
  scope: orchestration
  triggers: not-human-search-mcp, not human search mcp, how do i not-human-search-mcp, orchestrate not-human-search-mcp, automate
    not-human-search-mcp, agent not-human-search-mcp
  version: 1.0.0
