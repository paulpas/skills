---
name: patterns
description: '"Provides use this skill when implementing tasks according to conductor''s
  tdd workflow, handling phase checkpoints, managing git commits for tasks, or understan"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: workflow patterns, workflow, implementation guide
---
...
- When use this skill when implementing tasks according t...
