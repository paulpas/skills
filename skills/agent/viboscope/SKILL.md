---
name: viboscope
description: '"Provides Psychological compatibility matching — find cofounders,  collaborators,
...
metadata:
  ...
  output-format: code
  triggers: viboscope, collaboration, implementation guide
---
...
- When psychological compatibility matching — find cofoun...
