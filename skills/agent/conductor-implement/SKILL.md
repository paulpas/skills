---
name: implement
description: '"Provides Execute tasks from a track''s implementation plan following
  TDD workflow"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: conductor implement, workflow, implementation guide
---
...
- When execute tasks from a track's implementation plan f...
