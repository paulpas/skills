...
- examples
- do-dont
description: Implements intelligent create issue gate with multi-factor skill selection, fallback chains, and adherence to
...
metadata:
  ...
  role: orchestration
  scope: orchestration
  triggers: create-issue-gate, create issue gate, how do i create-issue-gate, orchestrate create-issue-gate, automate create-issue-gate,
    agent create-issue-gate
  version: 1.0.0
