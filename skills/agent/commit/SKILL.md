---
name: commit
description: '"Provides ALWAYS use this skill when committing code changes — never  commit
  directly without it. Creates commits following Sentry conventions with  proper conven"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: commit, workflow, implementation guide
---
...
- When always use this skill when committing code changes...
