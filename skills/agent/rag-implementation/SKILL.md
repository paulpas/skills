---
name: implementation
description: Provides RAG (Retrieval-Augmented Generation) implementation workflow
  covering embedding selection, vector database setup, chunking strategies, and retrieval
  o
license: MIT
...
- When rag (retrieval-augmented generation) implementatio...
