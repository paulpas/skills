---
name: automation
description: '''Provides Automate Zendesk tasks via Rube MCP (Composio): tickets,
  users, organizations, replies. Always search tools first for current schemas'''
license: MIT
...
- When automate zendesk tasks via rube mcp (composio): ti...
