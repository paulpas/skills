---
name: scripting
description: '"Provides Bash scripting workflow for creating production-ready shell
  scripts with defensive patterns, error handling, and testing"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: bash scripting, granular, workflow, how do i test
---
...
- When bash scripting workflow for creating production-re...
