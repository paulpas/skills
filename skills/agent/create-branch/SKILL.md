---
name: branch
description: '"Provides Create a git branch following Sentry naming conventions. Use
  when asked to"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: create branch, workflow, implementation guide
---
...
- When create a git branch following sentry naming conven...
