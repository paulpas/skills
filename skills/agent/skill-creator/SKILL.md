---
name: creator
description: '"Provides To create new CLI skills following Anthropic''s official best
  practices with zero manual configuration. This skill automates brainstorming, template
  ap"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: skill creator, meta, how do i automate
---
...
- When to create new cli skills following anthropic's off...
