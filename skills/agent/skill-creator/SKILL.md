...
- examples
- do-dont
description: Implements intelligent skill creator with multi-factor skill selection, fallback chains, and adherence to the
...
metadata:
  ...
  role: orchestration
  scope: orchestration
  triggers: skill-creator, skill creator, how do i skill-creator, orchestrate skill-creator, automate skill-creator, agent
    skill-creator
  version: 1.0.0
name: skill-creator
---
