---
name: automation
description: '''Provides Automate Airtable tasks via Rube MCP (Composio): records,
  bases, tables, fields, views. Always search tools first for current schemas'''
license: MIT
...
- When automate airtable tasks via rube mcp (composio): r...
