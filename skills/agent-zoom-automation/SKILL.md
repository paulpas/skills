...
description: "Provides Automate Zoom meeting creation, management, recordings, webinars, and participant tracking via Rube MCP (Composio). Always search tools first for curr"
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: zoom automation, automation, how do i automate, jenkins, ci/cd pipeline,
...
- When automate zoom meeting creation, management, record...
