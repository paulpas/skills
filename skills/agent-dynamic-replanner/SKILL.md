...
metadata:
  ...
  related-skills: agent-code-correctness-verifier, agent-confidence-based-selector, agent-error-trace-explainer, agent-multi-skill-executor, agent-parallel-skill-runner
---
