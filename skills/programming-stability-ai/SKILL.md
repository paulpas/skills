---
name: stability-ai
description: "Geracao de imagens via Stability AI (SD3.5, Ultra, Core). Text-to-image, img2img, inpainting, upscale, remove-bg, search-replace. 15 estilos artistico"
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: stability ai, media, implementation guide
---
...
- When geracao de imagens via stability ai (sd3.5, ultra,...
