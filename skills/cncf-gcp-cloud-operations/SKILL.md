...
metadata:
  ...
  related-skills: cncf-gcp-cloud-monitoring, cncf-gcp-compute-engine, cncf-gcp-gke, cncf-gcp-cloud-functions
---
...
Use google cloud operations when:
...
Avoid google cloud operations when:
