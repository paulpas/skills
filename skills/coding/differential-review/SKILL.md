---
name: review
description: '"Implements security-focused code review for prs, commits, and diffs
  patterns for software quality and development best practices."'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: differential review, security, how do i secure, security auditing, vulnerability
    scanning
---
...
- When security-focused code review for prs, commits, and...
