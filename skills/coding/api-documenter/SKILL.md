---
name: documenter
description: '"Provides Master API documentation with OpenAPI 3.1, AI-powered tools,
  and modern developer experience practices. Create interactive docs, generate SDKs,
  and bu"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: api documenter, backend, implementation guide
---
...
- When master api documentation with openapi 3.1, ai-powe...
