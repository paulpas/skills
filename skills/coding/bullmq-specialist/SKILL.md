---
name: specialist
description: '"Provides BullMQ expert for Redis-backed job queues, background processing,
...
metadata:
  ...
  output-format: code
  triggers: bullmq specialist, framework, implementation guide
---
...
- When bullmq expert for redis-backed job queues, backgro...
