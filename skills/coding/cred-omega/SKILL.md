---
name: omega
description: '"Provides CISO operacional enterprise para gestao total de credenciais
  e segredos"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: cred omega, security, how do i secure, security auditing, vulnerability
    scanning
---
...
- When ciso operacional enterprise para gestao total de c...
