---
name: patterns
description: '"Provides Build read models and projections from event streams. Use
  when implementing CQRS read sides, building materialized views, or optimizing query
  performa"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: projection patterns, architecture, implementation guide
---
...
- When build read models and projections from event strea...
