---
name: patterns
description: '"Provides API design principles and decision-making. REST vs GraphQL
  vs tRPC selection, response formats, versioning, pagination"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: api patterns, backend, implementation guide
---
...
- When api design principles and decision-making. rest vs...
