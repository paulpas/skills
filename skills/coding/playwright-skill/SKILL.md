---
name: skill
description: '''Provides IMPORTANT - Path Resolution: This skill can be installed
  in different locations (plugin system, manual installation, global, or project-specific).
  Bef'''
license: MIT
...
- When important - path resolution: this skill can be ins...
