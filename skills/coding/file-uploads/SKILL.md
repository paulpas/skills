---
name: uploads
description: '"Provides Expert at handling file uploads and cloud storage. Covers
  S3, Cloudflare R2, presigned URLs, multipart uploads, and image optimization. Knows
  how to h"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: file uploads, security, how do i secure, security auditing, vulnerability
    scanning
---
...
- When expert at handling file uploads and cloud storage....
