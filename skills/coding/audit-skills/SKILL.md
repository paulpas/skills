---
name: skills
description: '"Provides Expert security auditor for AI Skills and Bundles. Performs
  non-intrusive static analysis to identify malicious patterns, data leaks, system
  stability"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: audit skills, security, how do i secure, security auditing, vulnerability
    scanning
---
...
- When expert security auditor for ai skills and bundles....
