---
name: bugs
description: '"Provides Find bugs, security vulnerabilities, and code quality issues
  in local branch changes. Use when asked to review changes, find bugs, security review,
  or"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: find bugs, code, quality, how do i secure
---
...
- When find bugs, security vulnerabilities, and code qual...
