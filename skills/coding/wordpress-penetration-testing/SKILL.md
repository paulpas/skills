...
description: Provides Assess WordPress installations for common vulnerabilities and
  WordPress 7.0 attack surfaces
license: MIT
...
- When assess wordpress installations for common vulnerab...
