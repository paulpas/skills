---
name: architecture
description: '"Provides Guide for quality focused software architecture. This skill
  should be used when users want to write code, design architecture, analyze code,
  in any ca"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: software architecture, architecture, implementation guide
---
...
- When guide for quality focused software architecture. t...
