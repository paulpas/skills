---
name: pro
description: '"Provides Master Rust 1.75+ with modern async patterns, advanced type
  system features, and production-ready systems programming"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: rust pro, code, implementation guide
---
...
- When master rust 1.75+ with modern async patterns, adva...
