---
name: fixing
description: '"Provides Systematically identify and fix all failing tests using smart
  grouping strategies. Use when explicitly asks to fix tests ("'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: test fixing, development, and, how do i test
---
...
- When systematically identify and fix all failing tests ...
