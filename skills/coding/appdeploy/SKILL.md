---
name: appdeploy
description: '"Provides Deploy web apps with backend APIs, database, and file storage.
  Use when the user asks to deploy or publish a website or web app and wants a public
  URL"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: appdeploy, backend, how do i deploy
---
...
- When deploy web apps with backend apis, database, and f...
