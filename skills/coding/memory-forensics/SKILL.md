---
name: forensics
description: '"Provides Comprehensive techniques for acquiring, analyzing, and extracting
  artifacts from memory dumps for incident response and malware analysis"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: memory forensics, security, how do i secure, security auditing, vulnerability
    scanning
---
...
- When comprehensive techniques for acquiring, analyzing,...
