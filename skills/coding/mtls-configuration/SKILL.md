---
name: configuration
description: '"Provides Configure mutual TLS (mTLS) for zero-trust service-to-service
  communication. Use when implementing zero-trust networking, certificate management,
  or s"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: mtls configuration, security, how do i secure, security auditing, vulnerability
    scanning
---
...
- When configure mutual tls (mtls) for zero-trust service...
