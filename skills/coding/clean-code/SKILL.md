---
name: code
description: '"Implements this skill embodies the principles of patterns for software
  quality and development best practices."'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: clean code, code, quality, implementation guide
---
...
- When this skill embodies the principles of "clean code"...
