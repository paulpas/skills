---
name: graphql
description: Provides GraphQL gives clients exactly the data they need - no more,
  no less. One endpoint, typed schema, introspection. But the flexibility that makes
  it powe
license: MIT
...
- When graphql gives clients exactly the data they need -...
