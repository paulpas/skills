---
name: backend
description: '"Provides Build ASP.NET Core 8+ backend services with EF Core, auth,
...
metadata:
  ...
  output-format: code
  triggers: dotnet backend, backend, implementation guide
---
...
- When build asp.net core 8+ backend services with ef cor...
