---
name: review
description: '"Provides Professional code review with auto CHANGELOG generation, integrated
  with Codex AI. Use when you want professional code review before commits, you need"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: codex review, code, quality, implementation guide
---
...
- When professional code review with auto changelog gener...
