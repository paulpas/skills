---
name: analyst
description: '"Provides Expert firmware analyst specializing in embedded systems,
  IoT security, and hardware reverse engineering"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: firmware analyst, security, how do i secure, security auditing, vulnerability
    scanning
---
...
- When expert firmware analyst specializing in embedded s...
