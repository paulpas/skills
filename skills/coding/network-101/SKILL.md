---
name: '101'
description: '"Provides Configure and test common network services (HTTP, HTTPS, SNMP,
  SMB) for penetration testing lab environments. Enable hands-on practice with service
  en"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: network 101, testing, how do i test, test automation, unit tests
---
...
- When configure and test common network services (http, ...
