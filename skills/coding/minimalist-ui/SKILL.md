---
name: ui
description: '"Provides use when creating clean editorial interfaces with warm monochrome
  palettes, crisp borders, restrained motion, and flat bento layouts"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: minimalist ui, frontend, implementation guide
---
...
- When use when creating clean editorial interfaces with ...
