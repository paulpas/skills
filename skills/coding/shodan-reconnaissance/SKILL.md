---
name: reconnaissance
description: '"Provides Provide systematic methodologies for leveraging Shodan as
  a reconnaissance tool during penetration testing engagements"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: shodan reconnaissance, security, how do i test, security auditing, vulnerability
    scanning
---
...
- When provide systematic methodologies for leveraging sh...
