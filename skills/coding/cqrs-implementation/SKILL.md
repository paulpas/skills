---
name: implementation
description: '"Provides Implement Command Query Responsibility Segregation for scalable
  architectures. Use when separating read and write models, optimizing query performance"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: cqrs implementation, architecture, implementation guide
---
...
- When implement command query responsibility segregation...
