---
name: automation
description: Provides Browser automation powers web testing, scraping, and AI agent
  interactions. The difference between a flaky script and a reliable system comes
  down to
license: MIT
...
- When browser automation powers web testing, scraping, a...
