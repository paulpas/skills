---
name: sveltekit
description: '"Provides Build full-stack web applications with SvelteKit — file-based  routing,
  SSR, SSG, API routes, and form actions in one framework"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: sveltekit, frontend, implementation guide
---
...
- When build full-stack web applications with sveltekit —...
