...
description: '"Provides Project scaffolding templates for new applications. Use when
  creating new projects from scratch. Contains 12 templates for various tech stacks"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: templates, app, builder, implementation guide
---
...
- When project scaffolding templates for new applications...
