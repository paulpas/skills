---
name: framework
description: '"Provides ⚠️ AUTHORIZED USE ONLY > This skill is for educational  purposes
...
metadata:
  ...
  output-format: code
  triggers: metasploit framework, security, how do i secure, security auditing, vulnerability
    scanning
---
...
- When ⚠️ authorized use only > this skill is for educati...
