---
name: strategies
description: '"Provides Transform debugging from frustrating guesswork into systematic
  problem-solving with proven strategies, powerful tools, and methodical approaches"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: debugging strategies, development, and, how do i test
---
...
- When transform debugging from frustrating guesswork int...
