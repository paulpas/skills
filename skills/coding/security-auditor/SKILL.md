---
name: auditor
description: '"Provides Expert security auditor specializing in DevSecOps, comprehensive
...
metadata:
  ...
  output-format: code
  triggers: security auditor, security, how do i secure, security auditing, vulnerability
    scanning
---
...
- When expert security auditor specializing in devsecops,...
