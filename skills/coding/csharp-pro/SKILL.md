---
name: pro
description: '"Provides Write modern C# code with advanced features like records,
  pattern matching, and async/await. Optimizes .NET applications, implements enterprise
  patter"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: csharp pro, code, implementation guide
---
...
- When write modern c# code with advanced features like r...
