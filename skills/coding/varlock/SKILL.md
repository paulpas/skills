---
name: varlock
description: '"Provides Secure-by-default environment variable management for Claude
  Code sessions"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: varlock, security, how do i secure, security auditing, vulnerability scanning
---
...
- When secure-by-default environment variable management ...
