---
name: pro
description: '"Provides Master Python 3.12+ with modern features, async programming,
  performance optimization, and production-ready practices. Expert in the latest Python
  eco"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: python pro, code, how do i test
---
...
- When master python 3.12+ with modern features, async pr...
