---
name: patterns
description: '"Provides Jest testing patterns, factory functions, mocking strategies,
  and TDD workflow. Use when writing unit tests, creating test factories, or following
  TDD"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: testing patterns, testing, how do i test, test automation, unit tests
---
...
- When jest testing patterns, factory functions, mocking ...
