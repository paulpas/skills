...
- do-dont
- examples
description: '''Provides Exchange data normalization layer: typed dataclasses for ticker/trade/orderbook, exchange-specific
  parsing, and symbol format standardization'''
license: MIT
maturity: stable
metadata:
  domain: coding
