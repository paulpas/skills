---
name: orchestration
description: '"Provides Patterns for managing distributed transactions and long-running
  business processes"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: saga orchestration, architecture, implementation guide
---
...
- When patterns for managing distributed transactions and...
