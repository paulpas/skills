---
name: management
description: Provides Secure secrets management practices for CI/CD pipelines using
  Vault, AWS Secrets Manager, and other tools
license: MIT
...
- When secure secrets management practices for ci/cd pipe...
