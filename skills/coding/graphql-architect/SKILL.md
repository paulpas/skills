---
name: architect
description: '"Provides Master modern GraphQL with federation, performance optimization,
  and enterprise security. Build scalable schemas, implement advanced caching, and
  desi"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: graphql architect, architecture, how do i secure
---
...
- When master modern graphql with federation, performance...
