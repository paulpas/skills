---
name: engineer
description: '"Provides Expert reverse engineer specializing in binary analysis, disassembly,
...
metadata:
  ...
  output-format: code
  triggers: reverse engineer, security, how do i secure, security auditing, vulnerability
    scanning
---
...
- When expert reverse engineer specializing in binary ana...
