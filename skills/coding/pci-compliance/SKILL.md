---
name: compliance
description: '"Provides Master PCI DSS (Payment Card Industry Data Security Standard)
  compliance for secure payment processing and handling of cardholder data"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: pci compliance, security, how do i secure, security auditing, vulnerability
    scanning
---
...
- When master pci dss (payment card industry data securit...
