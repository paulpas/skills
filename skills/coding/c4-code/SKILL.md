---
name: code
description: '"Provides Expert C4 Code-level documentation specialist. Analyzes code
  directories to create comprehensive C4 code-level documentation including function
  signat"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: c4 code, architecture, implementation guide
---
...
- When expert c4 code-level documentation specialist. ana...
