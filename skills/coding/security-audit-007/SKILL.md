...
description: '"Provides Security audit, hardening, threat modeling (STRIDE/PASTA),
  Red/Blue Team, OWASP checks, code review, incident response, and infrastructure
  security fo"'
license: MIT
metadata:
  domain: coding
...
- When security audit, hardening, threat modeling (stride...
