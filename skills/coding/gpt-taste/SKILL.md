---
name: taste
description: '"Provides use when generating elite gsap-heavy frontend pages with strict
  aida structure, wide hero typography, and gapless bento grids"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: gpt taste, frontend, implementation guide
---
...
- When use when generating elite gsap-heavy frontend page...
