---
name: tools
description: '"Provides Master essential security scanning tools for network discovery,
  vulnerability assessment, web application testing, wireless security, and compliance
  v"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: scanning tools, security, how do i test, security auditing, vulnerability
    scanning
---
...
- When master essential security scanning tools for netwo...
