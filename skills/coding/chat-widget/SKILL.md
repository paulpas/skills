---
name: widget
description: '"Provides Build a real-time support chat system with a floating widget
  for users and an admin dashboard for support staff. Use when the user wants live
  chat, cu"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: chat widget, front, end, implementation guide
---
...
- When build a real-time support chat system with a float...
