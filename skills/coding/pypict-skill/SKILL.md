---
name: skill
description: '"Implements pairwise test generation patterns for software quality and
...
metadata:
  ...
  output-format: code
  triggers: pypict skill, testing, how do i test, test automation, unit tests
---
