---
name: kaizen
description: '"Provides Guide for continuous improvement, error proofing, and standardization.
  Use this skill when the user wants to improve code quality, refactor, or discus"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: kaizen, code, quality, implementation guide
---
...
- When guide for continuous improvement, error proofing, ...
