---
name: patterns
description: Provides Master proven backend architecture patterns including Clean
  Architecture, Hexagonal Architecture, and Domain-Driven Design to build maintainable,
  test
license: MIT
...
- When master proven backend architecture patterns includ...
