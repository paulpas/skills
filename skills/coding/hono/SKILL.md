---
name: hono
description: '"Provides Build ultra-fast web APIs and full-stack apps with Hono —  runs
  on Cloudflare Workers, Deno, Bun, Node.js, and any WinterCG-compatible runtime"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: hono, backend, implementation guide
---
...
- When build ultra-fast web apis and full-stack apps with...
