---
name: workflow
description: '"Provides Test-Driven Development workflow principles. RED-GREEN-REFACTOR
  cycle"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: tdd workflow, testing, how do i test, test automation, unit tests
---
...
- When test-driven development workflow principles. red-g...
