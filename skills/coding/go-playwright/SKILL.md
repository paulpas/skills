---
name: playwright
description: Provides Expert capability for robust, stealthy, and efficient browser
  automation using Playwright Go
license: MIT
...
- When expert capability for robust, stealthy, and effici...
