---
name: fullstack
description: '"Provides Build end-to-end type-safe APIs with tRPC — routers, procedures,  middleware,
  subscriptions, and Next.js/React integration patterns"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: trpc fullstack, framework, implementation guide
---
...
- When build end-to-end type-safe apis with trpc — router...
