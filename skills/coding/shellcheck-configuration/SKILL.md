---
name: configuration
description: '"Provides Master ShellCheck static analysis configuration and usage
  for shell script quality. Use when setting up linting infrastructure, fixing code
  issues, or"'
license: MIT
