---
name: authentication
description: '"Provides Identify and exploit authentication and session management
  vulnerabilities in web applications. Broken authentication consistently ranks in
  the OWASP"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: broken authentication, security, how do i secure, security auditing, vulnerability
    scanning
---
...
- When identify and exploit authentication and session ma...
