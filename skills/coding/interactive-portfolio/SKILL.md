---
name: portfolio
description: '"Provides Expert in building portfolios that actually land jobs and
  clients - not just showing work, but creating memorable experiences. Covers developer
  portfo"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: interactive portfolio, front, end, implementation guide
---
...
- When expert in building portfolios that actually land j...
