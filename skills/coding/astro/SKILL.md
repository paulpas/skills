---
name: astro
description: '"Provides Build content-focused websites with Astro — zero JS by  default,
  islands architecture, multi-framework components, and Markdown/MDX support"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: astro, frontend, implementation guide
---
...
- When build content-focused websites with astro — zero j...
