---
name: analysis
description: '"Provides Execute comprehensive network traffic analysis using Wireshark
  to capture, filter, and examine network packets for security investigations, performanc"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: wireshark analysis, security, how do i secure, security auditing, vulnerability
    scanning
---
...
- When execute comprehensive network traffic analysis usi...
