---
name: security
description: '"Provides Master smart contract security best practices, vulnerability
  prevention, and secure Solidity development patterns"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: solidity security, security, how do i secure, security auditing, vulnerability
    scanning
---
...
- When master smart contract security best practices, vul...
