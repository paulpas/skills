---
name: java
description: Provides Scaffold, write, debug, and enhance enterprise-grade Playwright
  E2E tests in Java using Page Object Model, JUnit 5, Allure reporting, and parallel
  exe
license: MIT
...
- When scaffold, write, debug, and enhance enterprise-gra...
