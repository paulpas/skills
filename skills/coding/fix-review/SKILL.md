---
name: review
description: '"Implements verify fix commits address audit findings without new bugs
...
metadata:
  ...
  output-format: code
  triggers: fix review, code, quality, implementation guide
---
...
- When verify fix commits address audit findings without ...
