---
name: context
description: '"Provides Expert C4 Context-level documentation specialist. Creates
  high-level system context diagrams, documents personas, user journeys, system features,
  and"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: c4 context, architecture, implementation guide
---
...
- When expert c4 context-level documentation specialist. ...
