---
name: automation
description: '''Provides Automate Freshservice ITSM tasks via Rube MCP (Composio):
  create/update tickets, bulk operations, service requests, and outbound emails. Always
  search'''
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: freshservice automation, project, management, how do i automate
---
...
- When automate freshservice itsm tasks via rube mcp (com...
