---
name: automation
description: '"Provides Master automated billing systems including recurring billing,
  invoice generation, dunning management, proration, and tax calculation"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: billing automation, uncategorized, how do i automate
---
...
- When master automated billing systems including recurri...
