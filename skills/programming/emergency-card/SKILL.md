---
name: card
description: '"Provides 生成紧急情况下快速访 问的医疗信息摘要卡片。当用户 需要旅行、就诊准备、紧急情况 或询问 functionality
  and capabilities."'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: emergency card, health, implementation guide
---
...
- When 生成紧急情况下快速访问的医疗信息摘要卡片。当用户需要旅行、就诊准备、紧急情况或询问"紧急信息"、"医...
