---
name: multiplayer
description: '"Provides Multiplayer game development principles. Architecture, networking,
  synchronization"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: multiplayer, game, development, implementation guide
---
...
- When multiplayer game development principles. architect...
