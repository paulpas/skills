---
name: automation
description: '"Provides Automate Box operations including file upload/download, content
  search, folder management, collaboration, metadata queries, and sign requests through"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: box automation, productivity, how do i automate
---
...
- When automate box operations including file upload/down...
