---
name: molykit
description: '"CRITICAL: Use for MolyKit AI chat toolkit. Triggers on" BotClient,
  OpenAI, SSE streaming, AI chat, molykit, PlatformSend, spawn(), ThreadToken, cross-platform
  async, Chat widget, M"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: molykit, ai, ml, implementation guide
---
...
- When critical: use for molykit ai chat toolkit. trigger...
