---
name: a11y
description: '"Provides Audit a StyleSeed-based component or page for WCAG 2.2 AA
  issues and apply practical accessibility fixes where the code makes them safe"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: ui a11y, design, implementation guide
---
...
- When audit a styleseed-based component or page for wcag...
