---
name: screenshots
description: '"Provides Generate marketing screenshots of your app using Playwright.
  Use when the user wants to create screenshots for Product Hunt, social media, landing
  pag"'
license: MIT
