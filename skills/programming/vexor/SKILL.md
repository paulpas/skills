---
name: vexor
description: '"Provides Vector-powered CLI for semantic file search with a Claude/Codex
  skill"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: vexor, development, implementation guide
---
...
- When vector-powered cli for semantic file search with a...
