---
name: check
description: '"Provides Validate Claude Code skills against the agentskills specification.
  Catches structural, semantic, and naming issues before users do"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: skill check, development, implementation guide
---
...
- When validate claude code skills against the agentskill...
