...
description: '"Provides Specialized guide for migrating Godot 3.x projects to Godot
  4 (GDScript 2.0), covering syntax changes, Tweens, and exports"'
license: MIT
metadata:
  domain: programming
  output-format: code
...
- When specialized guide for migrating godot 3.x projects...
