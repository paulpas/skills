---
name: matplotlib
description: '"Provides Matplotlib is Python''s foundational visualization library
...
metadata:
  ...
  output-format: code
  triggers: matplotlib, science, implementation guide
---
...
- When matplotlib is python's foundational visualization ...
