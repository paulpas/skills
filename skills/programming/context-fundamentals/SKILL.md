---
name: fundamentals
description: Provides Context is the complete state available to a language model
  at inference time. It includes everything the model can attend to when generating
  response
license: MIT
...
- When context is the complete state available to a langu...
