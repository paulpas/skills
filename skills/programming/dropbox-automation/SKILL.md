---
name: automation
description: '"Provides Automate Dropbox file management, sharing, search, uploads,
  downloads, and folder operations via Rube MCP (Composio). Always search tools first
  for cu"'
license: MIT
