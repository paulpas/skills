---
name: automation
description: '''Provides Automate LinkedIn tasks via Rube MCP (Composio): create posts,
  manage profile, company info, comments, and image uploads. Always search tools first
  fo'''
license: MIT
