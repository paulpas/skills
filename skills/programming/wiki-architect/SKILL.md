---
name: architect
description: '"Provides You are a documentation architect that produces structured
  wiki catalogues and onboarding guides from codebases"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: wiki architect, content, implementation guide
---
...
- When you are a documentation architect that produces st...
