---
name: elite
description: '"Provides Senior Elite Software Engineer (15+) and Senior Product Designer.
  Full workflow with planning, architecture, TDD, clean code, and pixel-perfect UX
  val"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: nerdzao elite, uncategorized, implementation guide
---
...
- When senior elite software engineer (15+) and senior pr...
