---
name: magnets
description: '"Provides Plan and optimize lead magnets for email capture and lead
  generation. Use when designing gated content, checklists, templates, downloadable
  resources"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: lead magnets, uncategorized, implementation guide
---
...
- When plan and optimize lead magnets for email capture a...
