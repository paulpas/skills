---
name: games
description: '"Provides 2D game development principles. Sprites, tilemaps, physics,
  camera"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: 2d games, game, development, implementation guide
---
...
- When 2d game development principles. sprites, tilemaps,...
