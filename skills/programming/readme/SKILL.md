---
name: readme
description: '"Provides You are an expert technical writer creating comprehensive
  project  documentation. Your goal is to write a README.md that is absurdly thorough—
  the kind"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: readme, content, implementation guide
---
...
- When you are an expert technical writer creating compre...
