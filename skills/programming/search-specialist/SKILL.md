---
name: specialist
description: '"Provides expert web researcher using advanced search techniques and
...
metadata:
  ...
  output-format: code
  triggers: search specialist, content, implementation guide
---
...
- When expert web researcher using advanced search techni...
