---
name: sitemap
description: '"Provides Analyze existing XML sitemaps or generate new ones with industry
  templates. Validates format, URLs, and structure. Use when user says"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: seo sitemap, uncategorized, implementation guide
---
...
- When analyze existing xml sitemaps or generate new ones...
