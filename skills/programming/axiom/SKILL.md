---
name: axiom
description: '"Provides First-principles assumption auditor. Classifies each hidden  assumption
  (fact / convention / belief / interest-driven), ranks by fragility  × impact, an"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: axiom, uncategorized, implementation guide
---
...
- When first-principles assumption auditor. classifies ea...
