---
name: astropy
description: Provides Astropy is the core Python package for astronomy, providing
  essential functionality for astronomical research and data analysis
license: MIT
...
- When astropy is the core python package for astronomy, ...
