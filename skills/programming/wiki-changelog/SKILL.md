---
name: changelog
description: '"Provides Generate structured changelogs from git history. Use when
  user asks"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: wiki changelog, content, implementation guide
---
...
- When generate structured changelogs from git history. u...
