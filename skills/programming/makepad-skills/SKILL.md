---
name: skills
description: '''Provides Makepad UI development skills for Rust apps: setup, patterns,
  shaders, packaging, and troubleshooting'''
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: makepad skills, development, implementation guide
---
...
- When makepad ui development skills for rust apps: setup...
