---
name: markup
description: Provides Design, validate, and optimize schema.org structured data for
  eligibility, correctness, and measurable SEO impact
license: MIT
...
- When design, validate, and optimize schema.org structur...
