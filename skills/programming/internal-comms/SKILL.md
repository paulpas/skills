---
name: comms
description: '"Provides Write internal communications such as status reports, leadership
  updates, 3P updates, newsletters, FAQs, incident reports, and project updates using
  r"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: internal comms, uncategorized, implementation guide
---
...
- When write internal communications such as status repor...
