---
name: fullstack
description: '"Provides Complete toolkit for senior fullstack with modern tools and
  best practices"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: senior fullstack, development, implementation guide
---
...
- When complete toolkit for senior fullstack with modern ...
