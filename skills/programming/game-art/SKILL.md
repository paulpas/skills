---
name: art
description: '"Provides Game art principles. Visual style selection, asset pipeline,
  animation workflow"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: game art, game, development, implementation guide
---
...
- When game art principles. visual style selection, asset...
