---
name: satori
description: '"Provides Clinically informed wisdom companion blending psychology and
  philosophy into a structured thinking partner"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: satori, personal, development, implementation guide
---
...
- When clinically informed wisdom companion blending psyc...
