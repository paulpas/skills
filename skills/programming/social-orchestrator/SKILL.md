---
name: orchestrator
description: '"Provides Orquestrador unificado de canais sociais — coordena Instagram,  Telegram
  e WhatsApp em um unico fluxo de trabalho. Publicacao cross-channel, metricas  u"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: social orchestrator, marketing, implementation guide
---
...
- When orquestrador unificado de canais sociais — coorden...
