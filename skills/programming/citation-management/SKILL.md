---
name: management
description: '"Provides Manage citations systematically throughout the research and
  writing process"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: citation management, content, implementation guide
---
...
- When manage citations systematically throughout the res...
