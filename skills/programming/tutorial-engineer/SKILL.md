...
description: '"Creates step-by-step tutorials and educational content from code. Transforms
  complex concepts into progressive learning experiences with hands-on exam"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: tutorial engineer, content, implementation guide
---
...
- When creates step-by-step tutorials and educational con...
