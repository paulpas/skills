---
name: strategy
description: '"Provides Design pricing, packaging, and monetization strategies based
  on value, customer willingness to pay, and growth objectives"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: pricing strategy, business, implementation guide
---
...
- When design pricing, packaging, and monetization strate...
