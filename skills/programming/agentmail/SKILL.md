---
name: agentmail
description: Provides Email infrastructure for AI agents. Create accounts, send/receive
  emails, manage webhooks, and check karma balance via the AgentMail API
license: MIT
...
- When email infrastructure for ai agents. create account...
