---
name: animation
description: '"Provides Three.js animation - keyframe animation, skeletal animation,
  morph targets, animation mixing. Use when animating objects, playing GLTF animations,
  cre"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: threejs animation, web, development, implementation guide
---
...
- When three.js animation - keyframe animation, skeletal ...
