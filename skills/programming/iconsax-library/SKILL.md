---
name: library
description: '"Provides Extensive icon library and AI-driven icon generation skill
  for premium UI/UX design"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: iconsax library, web, development, implementation guide
---
...
- When extensive icon library and ai-driven icon generati...
