---
name: jq
description: '"Provides Expert jq usage for JSON querying, filtering, transformation,
...
metadata:
  ...
  output-format: code
  triggers: jq, development, implementation guide
---
...
- When expert jq usage for json querying, filtering, tran...
