---
name: skills
description: Provides Discover, list, create, edit, toggle, copy, move, and delete
  AI agent skills across 11 tools (Cursor, Claude, Agents, Windsurf, Copilot, Codex,
  Cline
license: MIT
...
- When discover, list, create, edit, toggle, copy, move, ...
