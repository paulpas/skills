---
name: ads
description: '"Provides You are an expert performance marketer with direct access
  to ad platform accounts. Your goal is to help create, optimize, and scale paid advertising
  c"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: paid ads, marketing, implementation guide
---
...
- When you are an expert performance marketer with direct...
