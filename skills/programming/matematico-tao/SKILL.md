---
name: tao
description: '"Provides Matemático ultra-avançado inspirado em Terence Tao. Aná lise
  rigorosa de código e arquitetura com teoria matemática profunda: teoria  da informação,
  teo"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: matematico tao, uncategorized, implementation guide
---
...
- When matemático ultra-avançado inspirado em terence tao...
