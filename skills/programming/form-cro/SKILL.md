---
name: cro
description: '"Provides Optimize any form that is NOT signup or account registration  —
...
metadata:
  ...
  output-format: code
  triggers: form cro, marketing, implementation guide
---
...
- When optimize any form that is not signup or account re...
