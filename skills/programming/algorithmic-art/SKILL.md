---
name: art
description: '"Provides Algorithmic philosophies are computational aesthetic movements
  that are then expressed through code. Output .md files (philosophy), .html files
  (inter"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: algorithmic art, graphics, processing, implementation guide
---
...
- When algorithmic philosophies are computational aesthet...
