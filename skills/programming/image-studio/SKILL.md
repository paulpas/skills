---
name: studio
description: '"Provides Studio de geracao de imagens inteligente — roteamento  automatico
  entre ai-studio-image (fotos humanizadas/influencer) e stability-ai  (arte/ ilustracao"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: image studio, graphics, processing, how do i automate
---
...
- When studio de geracao de imagens inteligente — roteame...
