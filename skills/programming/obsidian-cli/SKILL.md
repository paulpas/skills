---
name: cli
description: '"Provides use the obsidian cli to read, create, search, and manage vault
  content, or to develop and debug obsidian plugins and themes from the command line"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: obsidian cli, uncategorized, implementation guide
---
...
- When use the obsidian cli to read, create, search, and ...
