---
name: sympy
description: '"Provides SymPy is a Python library for symbolic mathematics that enables
  exact computation using mathematical symbols rather than numerical approximations"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: sympy, science, implementation guide
---
...
- When sympy is a python library for symbolic mathematics...
