---
name: researcher
description: '"Provides You are an expert software engineer and systems analyst. Use
  when user asks"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: wiki researcher, content, implementation guide
---
...
- When you are an expert software engineer and systems an...
