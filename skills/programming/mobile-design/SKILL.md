---
name: design
description: '"Provides (mobile-first · touch-first · platform-respectful) functionality  and
  capabilities."'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: mobile design, mobile, implementation guide
---
...
- When (mobile-first · touch-first · platform-respectful)...
