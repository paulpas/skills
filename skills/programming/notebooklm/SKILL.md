---
name: notebooklm
description: Provides Interact with Google NotebookLM to query documentation with
  Gemini's source-grounded answers. Each question opens a fresh browser session, retrieves
  t
license: MIT
...
- When interact with google notebooklm to query documenta...
