---
name: networkx
description: '"Provides NetworkX is a Python package for creating, manipulating, and
...
metadata:
  ...
  output-format: code
  triggers: networkx, science, implementation guide
---
...
- When networkx is a python package for creating, manipul...
