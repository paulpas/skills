---
name: bulletmind
description: '"Provides Convert input into clean, structured, hierarchical bullet
  points for summarization, note-taking, and structured thinking"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: bulletmind, writing, implementation guide
---
...
- When convert input into clean, structured, hierarchical...
