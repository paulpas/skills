---
name: async
description: '"Provides Practical async patterns using TaskEither - clean pipelines
  instead of try/catch hell, with real API examples"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: fp async, development, implementation guide
---
...
- When practical async patterns using taskeither - clean ...
