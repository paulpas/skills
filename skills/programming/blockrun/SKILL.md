---
name: blockrun
description: '"Provides blockrun works with claude code and google antigravity functionality
  and capabilities."'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: blockrun, uncategorized, implementation guide
---
...
- When blockrun works with claude code and google antigra...
