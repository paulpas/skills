...
description: '"Provides expertise for analyzing DWARF debug files and understanding
  the DWARF debug format/standard (v3-v5). Triggers when understanding DWARF inform"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: dwarf expert, development, implementation guide
---
...
- When provides expertise for analyzing dwarf debug files...
