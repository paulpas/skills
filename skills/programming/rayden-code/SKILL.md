---
name: code
description: '"Provides Generate React code with Rayden UI components using correct
  props, tokens, and premium layout patterns"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: rayden code, development, implementation guide
---
...
- When generate react code with rayden ui components usin...
