---
name: wizard
description: '"Provides Done-for-you .faf generator. One-click AI context for any
  project - new, legacy, or famous. Auto-detects stack, scores readiness, works everywhere"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: faf wizard, productivity, implementation guide
---
...
- When done-for-you .faf generator. one-click ai context ...
