---
name: extractor
description: '"Extracts up to 50 highly relevant SEO keywords from text. Use when
  user wants to generate or extract keywords for given text" "'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: keyword extractor, marketing, implementation guide
---
...
- When extracts up to 50 highly relevant seo keywords fro...
