---
name: official
description: '"Provides a user may ask you to create, edit, or analyze the contents
  of a .pptx file. a .pptx file is essentially a zip archive containing xml files
  and other"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: pptx official, presentation, processing, implementation guide
---
