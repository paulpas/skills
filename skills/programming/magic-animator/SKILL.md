---
name: animator
description: '"Provides AI-powered animation tool for creating motion in logos, UI,
  icons, and social media assets"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: magic animator, uncategorized, implementation guide
---
...
- When ai-powered animation tool for creating motion in l...
