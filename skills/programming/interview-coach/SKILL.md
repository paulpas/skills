---
name: coach
description: '"Provides Full job search coaching system — JD decoding, resume,  storybank,
...
metadata:
  ...
  output-format: code
  triggers: interview coach, productivity, implementation guide
---
...
- When full job search coaching system — jd decoding, res...
