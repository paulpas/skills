---
name: tokens
description: '"Provides List, add, and update StyleSeed design tokens while keeping
  JSON sources, CSS variables, and dark-mode values in sync"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: ui tokens, design, implementation guide
---
...
- When list, add, and update styleseed design tokens whil...
