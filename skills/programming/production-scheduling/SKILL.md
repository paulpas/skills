---
name: scheduling
description: '"Provides Codified expertise for production scheduling, job sequencing,
  line balancing, changeover optimisation, and bottleneck resolution in discrete and
  batch"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: production scheduling, business, implementation guide
---
...
- When codified expertise for production scheduling, job ...
