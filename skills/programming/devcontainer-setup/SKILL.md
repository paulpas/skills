...
description: '"Creates devcontainers with Claude Code, language-specific tooling (Python/Node/Rust/Go),
  and persistent volumes. Use when adding devcontainer support"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: devcontainer setup, development, implementation guide
---
...
- When creates devcontainers with claude code, language-s...
