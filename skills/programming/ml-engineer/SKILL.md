---
name: engineer
description: Provides Build production ML systems with PyTorch 2.x, TensorFlow, and
  modern ML frameworks. Implements model serving, feature engineering, A/B testing,
  and mo
license: MIT
...
- When build production ml systems with pytorch 2.x, tens...
