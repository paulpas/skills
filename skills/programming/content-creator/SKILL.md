---
name: creator
description: '"Provides Professional-grade brand voice analysis, SEO optimization,
  and platform-specific content frameworks"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: content creator, marketing, implementation guide
---
...
- When professional-grade brand voice analysis, seo optim...
