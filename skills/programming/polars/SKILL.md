---
name: polars
description: Provides Fast in-memory DataFrame library for datasets that fit in RAM.
  Use when pandas is too slow but data still fits in memory. Lazy evaluation, parallel
  ex
license: MIT
...
- When fast in-memory dataframe library for datasets that...
