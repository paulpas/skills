---
name: audit
description: '"Provides Diagnose and audit SEO issues affecting crawlability, indexation,
...
metadata:
  ...
  output-format: code
  triggers: seo audit, content, implementation guide
---
...
- When diagnose and audit seo issues affecting crawlabili...
