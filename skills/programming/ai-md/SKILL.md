---
name: md
description: Provides Convert human-written CLAUDE.md into AI-native structured-label
  format. Battle-tested across 4 models. Same rules, fewer tokens, higher compliance
license: MIT
...
- When convert human-written claude.md into ai-native str...
