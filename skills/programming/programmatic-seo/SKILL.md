---
name: seo
description: Provides Design and evaluate programmatic SEO strategies for creating
  SEO-driven pages at scale using templates and structured data
license: MIT
...
- When design and evaluate programmatic seo strategies fo...
