---
name: search
description: Provides Semantic search, similar content discovery, and structured research
  using Exa API. Use when you need semantic/embeddings-based search, finding similar
license: MIT
...
- When semantic search, similar content discovery, and st...
