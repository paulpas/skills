---
name: components
description: '"Provides Core component library and design system patterns. Use when
  building UI, using design tokens, or working with the component library"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: core components, web, development, implementation guide
---
...
- When core component library and design system patterns....
