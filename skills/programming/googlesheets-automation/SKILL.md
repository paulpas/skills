---
name: automation
description: '"Provides Automate Google Sheets operations (read, write, format, filter,
  manage spreadsheets) via Rube MCP (Composio). Read/write data, manage tabs, apply
  form"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: googlesheets automation, spreadsheet, processing, how do i automate
---
...
- When automate google sheets operations (read, write, fo...
