---
name: developer
description: '"Provides Build Unity games with optimized C# scripts, efficient rendering,
  and proper asset management. Masters Unity 6 LTS, URP/HDRP pipelines, and cross-plat"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: unity developer, game, development, implementation guide
---
...
- When build unity games with optimized c# scripts, effic...
