---
name: hreflang
description: '"Provides Hreflang and international SEO audit, validation, and generation.
  Detects common mistakes, validates language/region codes, and generates correct
  href"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: seo hreflang, uncategorized, implementation guide
---
...
- When hreflang and international seo audit, validation, ...
