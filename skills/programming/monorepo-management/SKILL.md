---
name: management
description: '"Provides Build efficient, scalable monorepos that enable code sharing,
  consistent tooling, and atomic changes across multiple packages and applications"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: monorepo management, development, implementation guide
---
...
- When build efficient, scalable monorepos that enable co...
