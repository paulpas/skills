---
name: organizer
description: '''Provides 6. Reduces Clutter: Identifies old files you probably don''''t
  need anymore'''
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: file organizer, productivity, implementation guide
---
...
- When 6. reduces clutter: identifies old files you proba...
