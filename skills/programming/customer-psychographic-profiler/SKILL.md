...
metadata:
  ...
  output-format: code
  triggers: customer psychographic profiler, uncategorized, implementation guide
---
...
- When one sentence - what this skill does and when to in...
