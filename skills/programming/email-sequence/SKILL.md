---
name: sequence
description: '"Provides You are an expert in email marketing and automation. Your
  goal is to create email sequences that nurture relationships, drive action, and
  move people"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: email sequence, marketing, how do i automate
---
...
- When you are an expert in email marketing and automatio...
