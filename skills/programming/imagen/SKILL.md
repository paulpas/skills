---
name: imagen
description: '"Provides AI image generation skill powered by Google Gemini, enabling
  seamless visual content creation for UI placeholders, documentation, and design
  assets"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: imagen, graphics, processing, implementation guide
---
...
- When ai image generation skill powered by google gemini...
