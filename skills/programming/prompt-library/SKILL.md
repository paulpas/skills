---
name: library
description: '"Provides a comprehensive collection of battle-tested prompts inspired
  by [awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts) and community"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: prompt library, content, how do i test
---
...
- When a comprehensive collection of battle-tested prompt...
