---
name: design
description: '"Provides Design de produto nivel Apple — sistemas visuais, UX flows,  acessibilidade,
  linguagem visual proprietaria, design tokens, prototipagem e handoff.  Cobr"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: product design, business, implementation guide
---
...
- When design de produto nivel apple — sistemas visuais, ...
