---
name: component
description: '"Provides Generate a new UI component that follows StyleSeed Toss conventions
  for structure, tokens, accessibility, and component ergonomics"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: ui component, design, implementation guide
---
...
- When generate a new ui component that follows styleseed...
