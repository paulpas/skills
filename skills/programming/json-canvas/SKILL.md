---
name: canvas
description: '"Provides Create and edit JSON Canvas files (.canvas) with nodes, edges,
  groups, and connections. Use when working with .canvas files, creating visual canvases"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: json canvas, uncategorized, implementation guide
---
...
- When create and edit json canvas files (.canvas) with n...
