---
name: ar
description: '"Provides VR/AR development principles. Comfort, interaction, performance
  requirements"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: vr ar, game, development, implementation guide
---
...
- When vr/ar development principles. comfort, interaction...
