---
name: automation
description: '''Provides Automate Miro tasks via Rube MCP (Composio): boards, items,
  sticky notes, frames, sharing, connectors. Always search tools first for current
  schemas'''
license: MIT
