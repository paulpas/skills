---
name: testing
description: Provides Master comprehensive testing strategies for smart contracts
  using Hardhat, Foundry, and advanced testing patterns
license: MIT
...
- When master comprehensive testing strategies for smart ...
