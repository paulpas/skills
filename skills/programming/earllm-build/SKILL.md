---
name: build
description: '"Provides Build, maintain, and extend the EarLLM One Android project  —
  a Kotlin/Compose app that connects Bluetooth earbuds to an LLM via voice  pipeline"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: earllm build, uncategorized, implementation guide
---
...
- When build, maintain, and extend the earllm one android...
