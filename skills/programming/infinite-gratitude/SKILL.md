---
name: gratitude
description: Provides Multi-agent research skill for parallel research execution (10
  agents, battle-tested with real case studies)
license: MIT
...
- When multi-agent research skill for parallel research e...
