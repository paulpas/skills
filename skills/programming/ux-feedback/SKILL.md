---
name: feedback
description: '"Provides Add loading, empty, error, and success feedback states to
  StyleSeed components and pages with practical mobile-first rules"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: ux feedback, design, implementation guide
---
...
- When add loading, empty, error, and success feedback st...
