---
name: scraper
description: Provides Deep web scraping, screenshots, PDF parsing, and website crawling
  using Firecrawl API. Use when you need deep content extraction from web pages, page
license: MIT
...
- When deep web scraping, screenshots, pdf parsing, and w...
