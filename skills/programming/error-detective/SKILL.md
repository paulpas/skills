---
name: detective
description: '"Provides Search logs and codebases for error patterns, stack traces,
  and anomalies. Correlates errors across systems and identifies root causes"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: error detective, development, implementation guide
---
...
- When search logs and codebases for error patterns, stac...
