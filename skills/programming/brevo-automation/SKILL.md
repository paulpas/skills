---
name: automation
description: '"Provides Automate Brevo (formerly Sendinblue) email marketing operations
  through Composio''s Brevo toolkit via Rube MCP"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: brevo automation, marketing, how do i automate
---
...
- When automate brevo (formerly sendinblue) email marketi...
