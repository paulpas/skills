---
name: calc
description: '"Provides Spreadsheet creation, format conversion (ODS/XLSX/CSV), formulas,
  data automation with LibreOffice Calc"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: calc, spreadsheet, processing, how do i automate
---
...
- When spreadsheet creation, format conversion (ods/xlsx/...
