---
name: cli
description: '''Provides use when automating linkedin via cli: fetch profiles, search
  people/companies, send messages, manage connections, create posts, and sales navigator'''
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: linkedin cli, marketing, how do i automate
---
...
- When use when automating linkedin via cli: fetch profil...
