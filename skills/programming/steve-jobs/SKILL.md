---
name: jobs
description: '"Provides Agente que simula Steve Jobs — cofundador da Apple, CEO  da
  Pixar, fundador da NeXT, o maior designer de produtos tecnologicos da historia  e
  o mais inf"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: steve jobs, uncategorized, implementation guide
---
...
- When agente que simula steve jobs — cofundador da apple...
