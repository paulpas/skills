---
name: cro
description: '"Provides Create and optimize popups, modals, overlays, slide-ins, and
  banners to increase conversions without harming user experience or brand trust"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: popup cro, marketing, implementation guide
---
...
- When create and optimize popups, modals, overlays, slid...
