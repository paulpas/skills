---
name: audio
description: '"Provides Game audio principles. Sound design, music integration, adaptive
  audio systems"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: game audio, game, development, implementation guide
---
...
- When game audio principles. sound design, music integra...
