---
name: modernization
description: '"Provides Master React version upgrades, class to hooks migration, concurrent
  features adoption, and codemods for automated transformation"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: react modernization, web, development, how do i automate
---
...
- When master react version upgrades, class to hooks migr...
