---
name: orchestrator
description: Provides Meta-skill que orquestra todos os agentes do ecossistema. Scan
  automatico de skills, match por capacidades, coordenacao de workflows multi-skill
  e reg
license: MIT
...
- When meta-skill que orquestra todos os agentes do ecoss...
