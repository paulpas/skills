---
name: configuration
description: Provides Complete guide to Prometheus setup, metric collection, scrape
  configuration, and recording rules
license: MIT
...
- When complete guide to prometheus setup, metric collect...
