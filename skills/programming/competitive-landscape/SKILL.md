---
name: landscape
description: '"Provides Comprehensive frameworks for analyzing competition, identifying
  differentiation opportunities, and developing winning market positioning strategies"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: competitive landscape, business, implementation guide
---
...
- When comprehensive frameworks for analyzing competition...
