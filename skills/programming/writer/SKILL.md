---
name: writer
description: '"Provides Document creation, format conversion (ODT/DOCX/PDF), mail
  merge, and automation with LibreOffice Writer"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: writer, document, processing, how do i automate
---
...
- When document creation, format conversion (odt/docx/pdf...
