...
description: '"Creates exhaustive technical references and API documentation. Generates
  comprehensive parameter listings, configuration guides, and searchable refere"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: reference builder, content, implementation guide
---
...
- When creates exhaustive technical references and api do...
