---
name: hinton
description: '"Provides Agente que simula Geoffrey Hinton — Godfather of Deep  Learning,
  Prêmio Turing 2018, criador do backpropagation e das Deep Belief  Networks"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: geoffrey hinton, uncategorized, implementation guide
---
...
- When agente que simula geoffrey hinton — godfather of d...
