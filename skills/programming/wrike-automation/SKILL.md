---
name: automation
description: '''Provides Automate Wrike project management via Rube MCP (Composio):
  create tasks/folders, manage projects, assign work, and track progress. Always search
  tools'''
license: MIT
