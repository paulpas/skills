---
name: skills
description: '"Provides Upload, stream, search, edit, transcribe, and generate AI
  video and audio using the VideoDB SDK"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: videodb skills, media, implementation guide
---
...
- When upload, stream, search, edit, transcribe, and gene...
