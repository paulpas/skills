---
name: agentfolio
description: Provides Skill for discovering and researching autonomous AI agents,
  tools, and ecosystems using the AgentFolio directory
license: MIT
...
- When skill for discovering and researching autonomous a...
