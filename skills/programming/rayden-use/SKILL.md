---
name: use
description: '"Provides Build and maintain Rayden UI components and screens in Figma
  via Figma MCP with full design token enforcement"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: rayden use, design, implementation guide
---
...
- When build and maintain rayden ui components and screen...
