---
name: last30days
description: '"Provides Research a topic from the last 30 days on Reddit + X + Web,
  become an expert, and write copy-paste-ready prompts for the user''s target tool"'
license: MIT
