...
metadata:
  ...
  output-format: code
  triggers: error diagnostics error trace, development, implementation guide
---
...
- When you are an error tracking and observability expert...
