---
name: summarizer
description: '"Provides Extract transcripts from YouTube videos and generate comprehensive,
...
metadata:
  ...
  output-format: code
  triggers: youtube summarizer, content, implementation guide
---
...
- When extract transcripts from youtube videos and genera...
