---
name: draw
description: '"Provides Vector graphics and diagram creation, format conversion (ODG/SVG/PDF)
...
metadata:
  ...
  output-format: code
  triggers: draw, graphics, processing, implementation guide
---
...
- When vector graphics and diagram creation, format conve...
