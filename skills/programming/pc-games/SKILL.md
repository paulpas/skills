---
name: games
description: '"Provides PC and console game development principles. Engine selection,
  platform features, optimization strategies"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: pc games, game, development, implementation guide
---
...
- When pc and console game development principles. engine...
