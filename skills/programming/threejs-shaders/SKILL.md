---
name: shaders
description: '"Provides Three.js shaders - GLSL, ShaderMaterial, uniforms, custom
  effects. Use when creating custom visual effects, modifying vertices, writing fragment
  shade"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: threejs shaders, web, development, implementation guide
---
...
- When three.js shaders - glsl, shadermaterial, uniforms,...
