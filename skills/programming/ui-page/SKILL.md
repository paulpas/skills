---
name: page
description: '"Provides Scaffold a new mobile-first page using StyleSeed Toss layout
  patterns, section rhythm, and existing shell components"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: ui page, design, implementation guide
---
...
- When scaffold a new mobile-first page using styleseed t...
