---
name: evolution
description: '"Provides this skill enables makepad-skills to self-improve continuously
  during development"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: evolution, uncategorized, implementation guide
---
...
- When this skill enables makepad-skills to self-improve ...
