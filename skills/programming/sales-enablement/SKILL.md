---
name: enablement
description: '"Provides Create sales collateral such as decks, one-pagers, objection
  docs, demo scripts, playbooks, and proposal templates. Use when a sales team needs
  assets"'
license: MIT
