---
name: impress
description: '"Provides Presentation creation, format conversion (ODP/PPTX/PDF), slide
  automation with LibreOffice Impress"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: impress, presentation, processing, how do i automate
---
...
- When presentation creation, format conversion (odp/pptx...
