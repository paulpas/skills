---
name: ops
description: Provides LLM Operations -- RAG, embeddings, vector databases, fine-tuning,
  prompt engineering avancado, custos de LLM, evals de qualidade e arquiteturas de
  IA
license: MIT
...
- When llm operations -- rag, embeddings, vector database...
