---
name: angular
description: '"Provides Modern Angular (v20+) expert with deep knowledge of Signals,
  Standalone Components, Zoneless applications, SSR/Hydration, and reactive patterns"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: angular, web, development, implementation guide
---
...
- When modern angular (v20+) expert with deep knowledge o...
