---
name: automation
description: '''Provides Automate Twitter/X tasks via Rube MCP (Composio): posts,
  search, users, bookmarks, lists, media. Always search tools first for current schemas'''
license: MIT
