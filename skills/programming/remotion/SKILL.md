---
name: remotion
description: '"Provides Generate walkthrough videos from Stitch projects using Remotion
  with smooth transitions, zooming, and text overlays"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: remotion, media, implementation guide
---
...
- When generate walkthrough videos from stitch projects u...
