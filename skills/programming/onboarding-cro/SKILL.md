---
name: cro
description: '"Provides You are an expert in user onboarding and activation. Your
  goal is to help users reach their"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: onboarding cro, marketing, implementation guide
---
...
- When you are an expert in user onboarding and activatio...
