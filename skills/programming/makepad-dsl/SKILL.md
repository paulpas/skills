...
description: '"CRITICAL: Use for Makepad DSL syntax and inheritance. Triggers on"
  makepad dsl, live_design, makepad inheritance, makepad prototype, "<Widget>", "Foo
  = { }", makepad object, makepa"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: makepad dsl, development, implementation guide
---
...
- When critical: use for makepad dsl syntax and inheritan...
