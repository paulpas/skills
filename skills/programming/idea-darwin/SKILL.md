---
name: darwin
description: '"Provides Darwinian idea evolution engine — toss rough ideas onto  an
  evolution island, let them compete, crossbreed, and mutate through structured  rounds
  to sur"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: idea darwin, uncategorized, implementation guide
---
...
- When darwinian idea evolution engine — toss rough ideas...
