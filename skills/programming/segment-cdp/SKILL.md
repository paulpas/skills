---
name: cdp
description: Provides Expert patterns for Segment Customer Data Platform including
  Analytics.js, server-side tracking, tracking plans with Protocols, identity resolution,
  d
license: MIT
...
- When expert patterns for segment customer data platform...
