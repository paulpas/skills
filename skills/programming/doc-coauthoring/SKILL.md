---
name: coauthoring
description: '"Provides this skill provides a structured workflow for guiding users
  through collaborative document creation. act as an active guide, walking users through
  thr"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: doc coauthoring, document, processing, implementation guide
---
...
- When this skill provides a structured workflow for guid...
