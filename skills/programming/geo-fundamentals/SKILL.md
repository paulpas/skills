---
name: fundamentals
description: '"Provides Generative Engine Optimization for AI search engines (ChatGPT,
  Claude, Perplexity)"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: geo fundamentals, marketing, implementation guide
---
...
- When generative engine optimization for ai search engin...
