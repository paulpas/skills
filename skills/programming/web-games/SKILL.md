---
name: games
description: '"Provides Web browser game development principles. Framework selection,
  WebGPU, optimization, PWA"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: web games, game, development, implementation guide
---
...
- When web browser game development principles. framework...
