---
name: slides
description: '"Provides Create stunning, animation-rich HTML presentations from scratch
  or by converting PowerPoint files"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: frontend slides, presentation, processing, implementation guide
---
...
- When create stunning, animation-rich html presentations...
