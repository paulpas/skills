---
name: statsmodels
description: '"Provides Statsmodels is Python''s premier library for statistical modeling,
  providing tools for estimation, inference, and diagnostics across a wide range of
  st"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: statsmodels, science, implementation guide
---
...
- When statsmodels is python's premier library for statis...
