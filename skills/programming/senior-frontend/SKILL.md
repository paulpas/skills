---
name: frontend
description: '"Provides Frontend development skill for React, Next.js, TypeScript,
  and Tailwind CSS applications. Use when building React components, optimizing Next.js
  perfo"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: senior frontend, web, development, implementation guide
---
...
- When frontend development skill for react, next.js, typ...
