---
name: templates
description: '"Provides Documentation templates and structure guidelines. README,
  API docs, code comments, and AI-friendly documentation"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: documentation templates, content, implementation guide
---
...
- When documentation templates and structure guidelines. ...
