---
name: plotly
description: Provides Interactive visualization library. Use when you need hover info,
  zoom, pan, or web-embeddable charts. Best for dashboards, exploratory analysis,
  and p
license: MIT
...
- When interactive visualization library. use when you ne...
