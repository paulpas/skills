---
name: architect
description: '"Provides Complete toolkit for senior architect with modern tools and
  best practices"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: senior architect, development, implementation guide
---
...
- When complete toolkit for senior architect with modern ...
