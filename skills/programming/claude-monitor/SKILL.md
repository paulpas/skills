---
name: monitor
description: Provides Monitor de performance do Claude Code e sistema local. Diagnostica
  lentidao, mede CPU/RAM/disco, verifica API latency e gera relatorios de saude do
  si
license: MIT
...
- When monitor de performance do claude code e sistema lo...
