---
name: automation
description: '''Provides Automate YouTube tasks via Rube MCP (Composio): upload videos,
  manage playlists, search content, get analytics, and handle comments. Always search
  too'''
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: youtube automation, marketing, how do i automate
---
...
- When automate youtube tasks via rube mcp (composio): up...
