---
name: code
description: '"Provides Review a diff for clarity and safe simplifications, then optionally
...
metadata:
  ...
  output-format: code
  triggers: simplify code, uncategorized, implementation guide
---
...
- When review a diff for clarity and safe simplifications...
