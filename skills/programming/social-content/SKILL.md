---
name: content
description: '"Provides You are an expert social media strategist with direct access
  to a scheduling platform that publishes to all major social networks. Your goal
  is to hel"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: social content, marketing, implementation guide
---
...
- When you are an expert social media strategist with dir...
