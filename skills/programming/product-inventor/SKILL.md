---
name: inventor
description: '"Provides Product Inventor e Design Alchemist de nivel maximo —  combina
  Product Thinking, Design Systems, UI Engineering, Psicologia Cognitiva,  Storytelling
  e e"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: product inventor, business, implementation guide
---
...
- When product inventor e design alchemist de nivel maxim...
