---
name: errors
description: '"Provides Stop throwing everywhere - handle errors as values using Either
  and TaskEither for cleaner, more predictable code"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: fp errors, development, implementation guide
---
...
- When stop throwing everywhere - handle errors as values...
