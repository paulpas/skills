---
name: patterns
description: Provides Production patterns for Linkerd service mesh - the lightweight,
  security-first service mesh for Kubernetes
license: MIT
...
- When production patterns for linkerd service mesh - the...
