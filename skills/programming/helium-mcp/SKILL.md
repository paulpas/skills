---
name: mcp
description: Provides Connect to Helium's MCP server for news research, media bias
  analysis, balanced perspectives, stock/options data, and semantic meme search across
  3.2M
license: MIT
...
- When connect to helium's mcp server for news research, ...
