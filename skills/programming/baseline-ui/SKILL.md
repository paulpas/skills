...
description: '"Validates animation durations, enforces typography scale, checks component
  accessibility, and prevents layout anti-patterns in Tailwind CSS projects"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: baseline ui, web, development, implementation guide
---
...
- When validates animation durations, enforces typography...
