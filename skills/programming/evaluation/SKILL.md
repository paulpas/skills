---
name: evaluation
description: Provides Build evaluation frameworks for agent systems. Use when testing
  agent performance systematically, validating context engineering choices, or measuring
license: MIT
...
- When build evaluation frameworks for agent systems. use...
