---
name: markdown
description: '"Provides Create and edit Obsidian Flavored Markdown with wikilinks,
  embeds, callouts, properties, and other Obsidian-specific syntax. Use when working
  with .md"'
license: MIT
