---
name: development
description: '"Provides Game development orchestrator. Routes to platform-specific
  skills based on project needs"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: game development, game, development, implementation guide
---
...
- When game development orchestrator. routes to platform-...
