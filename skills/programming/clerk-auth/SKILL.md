---
name: auth
description: '"Provides Expert patterns for Clerk auth implementation, middleware,
...
metadata:
  ...
  output-format: code
  triggers: clerk auth, uncategorized, implementation guide
---
...
- When expert patterns for clerk auth implementation, mid...
