---
name: prose
description: '"Provides a hard-edged writing style contract for timeless, forceful
  english prose without modern ai tics. use when users ask for prose or rewrites that
  must be"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: beautiful prose, content, implementation guide
---
...
- When a hard-edged writing style contract for timeless, ...
