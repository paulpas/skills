---
name: os
description: '"Provides Five-phase pipeline (triage → clarify → research  → PRD →
  plan) that turns a raw idea into four linked files: clarifying  questions, deep
  research, a PR"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: idea os, product, management, implementation guide
---
...
- When five-phase pipeline (triage → clarify → research →...
