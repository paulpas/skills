---
name: windows
description: '"Provides PowerShell Windows patterns. Critical pitfalls, operator syntax,
  error handling"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: powershell windows, uncategorized, implementation guide
---
...
- When powershell windows patterns. critical pitfalls, op...
