---
name: reviewer
description: '"Provides Elite code review expert specializing in modern AI-powered
  code"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: code reviewer, development, implementation guide
---
...
- When elite code review expert specializing in modern ai...
