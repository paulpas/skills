---
name: cli
description: '"Provides use mmx to generate text, images, video, speech, and music
  via the minimax ai platform. use when the user wants to create media content, chat
  with min"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: mmx cli, uncategorized, implementation guide
---
...
- When use mmx to generate text, images, video, speech, a...
