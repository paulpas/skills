---
name: bases
description: Provides Create and edit Obsidian Bases (.base files) with views, filters,
  formulas, and summaries. Use when working with .base files, creating database-like
  v
license: MIT
...
- When create and edit obsidian bases (.base files) with ...
