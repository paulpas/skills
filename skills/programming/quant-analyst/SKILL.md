---
name: analyst
description: '"Provides Build financial models, backtest trading strategies, and analyze
  market data. Implements risk metrics, portfolio optimization, and statistical arbitra"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: quant analyst, business, how do i test
---
...
- When build financial models, backtest trading strategie...
