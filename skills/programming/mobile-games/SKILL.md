---
name: games
description: '"Provides Mobile game development principles. Touch input, battery,
  performance, app stores"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: mobile games, game, development, implementation guide
---
...
- When mobile game development principles. touch input, b...
