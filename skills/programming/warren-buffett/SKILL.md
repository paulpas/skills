---
name: buffett
description: '"Provides Agente que simula Warren Buffett — o maior investidor  do
  seculo XX e XXI, CEO da Berkshire Hathaway, discipulo de Benjamin Graham e  socio
  intelectual"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: warren buffett, uncategorized, implementation guide
---
...
- When agente que simula warren buffett — o maior investi...
