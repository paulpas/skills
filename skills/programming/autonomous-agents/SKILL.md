---
name: agents
description: Provides Autonomous agents are AI systems that can independently decompose
  goals, plan actions, execute tools, and self-correct without constant human guidance
license: MIT
...
- When autonomous agents are ai systems that can independ...
