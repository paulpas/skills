---
name: strategy
description: '"Provides You are an expert in SaaS product launches and feature announcements.
...
metadata:
  ...
  output-format: code
  triggers: launch strategy, marketing, implementation guide
---
...
- When you are an expert in saas product launches and fea...
