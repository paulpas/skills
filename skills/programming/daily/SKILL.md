---
name: daily
description: '"Provides documentation and capabilities reference for daily functionality
  and capabilities."'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: daily, uncategorized, implementation guide
---
...
- When documentation and capabilities reference for daily...
