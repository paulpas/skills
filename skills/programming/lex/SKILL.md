---
name: lex
description: '"Provides Centralized ''Truth Engine'' for cross-jurisdictional legal
  context (US, EU, CA) and contract scaffolding"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: lex, legal, implementation guide
---
...
- When centralized 'truth engine' for cross-jurisdictiona...
