...
description: "\"Provides Tailwind CSS v4 principles. CSS-first configuration, container queries, modern patterns, design token architecture\""
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: tailwind patterns, frontend, implementation guide
---
...
- When tailwind css v4 principles. css-first configuratio...
