---
name: cncf-kubeflow
description: "\"Configures kubeflow in cloud-native engineering - ml on kubernetes for cloud-native deployment and infrastructure management.\""
license: MIT
...
**Primary Language:** Go  
**Documentation:** [https://www.kubeflow.org/](https://www.kubeflow.org/)  

---

## Purpose and Use Cases

Kubeflow is a ML on Kubernetes designed to help engineers build, deploy, and manage cloud-native applications.

### What Problem Does It Solve?

Kubeflow addresses complex ml challenges by providing:
...
Use Kubeflow when you need ML on Kubernetes, require ml-specific features, want to integrate with other CNCF projects, need production-ready ml solutions, or require ml-specific best practices.

### Key Use Cases

- **Kubeflow Core**: Primary use case for ML on Kubernetes
...
- **Kubernetes**: Core platform for Kubeflow
...
```yaml
# Example configuration for Kubeflow
apiVersion: cncf.kubeflow/v1
kind: Kubeflow
metadata:
  name: example
  namespace: default
...
- **Resource**: Core abstraction managed by Kubeflow
...
- **Official Documentation:** [https://www.kubeflow.org/](https://www.kubeflow.org/)
- **GitHub Repository:** [github.com/cncf/kubeflow](https://github.com/cncf/kubeflow)
- **CNCF Project Page:** [cncf.io/projects/kubeflow/](https://www.cncf.io/projects/kubeflow/)
