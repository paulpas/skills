...
metadata:
  ...
  related-skills: cncf-gcp-cloud-functions, cncf-gcp-cloud-pubsub, cncf-gcp-app-engine, cncf-gcp-cloud-monitoring
---
...
| `cncf-gcp-cloud-pubsub` | Related infrastructure service |
| `cncf-gcp-app-engine` | Related infrastructure service |
