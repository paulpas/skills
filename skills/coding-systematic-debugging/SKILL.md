...
description: "\"Provides use when encountering any bug, test failure, or unexpected behavior, before proposing fixes\""
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: systematic debugging, development, and, how do i test
---
...
- When use when encountering any bug, test failure, or un...
