...
metadata:
  ...
  triggers: cdn, content delivery, content distribution, caching, global delivery, cloudfront, elasticache, redis
  version: 1.0.0
name: cdn
---
# Azure CDN
...
| Skill | Purpose |
|---|---|
| `cncf-azure-blob-storage` | Related infrastructure service |
| `cncf-azure-virtual-machines` | Related infrastructure service |
| `cncf-azure-monitor` | Related infrastructure service |
| `cncf-azure-app-service` | Related infrastructure service |
---
