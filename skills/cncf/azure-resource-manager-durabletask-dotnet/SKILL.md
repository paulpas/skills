---
name: resource-manager-durabletask-dotnet
...
metadata:
  ...
  output-format: code
  triggers: azure resource manager durabletask dotnet, cloud, implementation guide
---
...
- When azure resource manager sdk for durable task schedu...
