...
- do-dont
- config
description: '"Container Network Interface in Cloud Native Network - cloud native architecture" patterns, pitfalls, and best
  practices'
license: MIT
maturity: stable
metadata:
  ...
  triggers: architecture, cdn, container network interface cni, container-network-interface-cni, infrastructure as code, monitoring,
