...
metadata:
  ...
  related-skills: calico, notary-project, open-policy-agent-opa, ory-hydra
  role: reference
  scope: infrastructure
  triggers: cdn, compliance, how do i find security issues, infrastructure as code, monitoring, openfga, security, vulnerability
    scanning
  version: 1.0.0
name: openfga
---
