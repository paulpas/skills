...
metadata:
  ...
  related-skills: ory-kratos
  role: reference
  scope: infrastructure
  triggers: access, cdn, identity, infrastructure as code, monitoring, oathkeeper, cloudformation, cloudfront
  version: 1.0.0
name: oathkeeper
---
...
**Primary Language:** Go  
**Documentation:** [https://github.com/ory/oathkeeper](https://github.com/ory/oathkeeper)  

---

## Purpose and Use Cases

Oathkeeper is a cloud-native project that provides security functionality for modern distributed systems.

### What Problem Does It Solve?

Oathkeeper addresses the challenges of security in cloud-native environments, enabling teams to implement security features without embedding them in application code.

### When to Use This Project

Use oathkeeper when you need security capabilities in your Kubernetes or cloud-native infrastructure. It's ideal when you require security with minimal application code changes.
