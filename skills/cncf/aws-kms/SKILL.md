...
- do-dont
- config
description: '"Manages encryption keys with AWS KMS for data protection at rest and" in transit, key rotation, and compliance
  with encryption standards across all AWS services.'
license: MIT
maturity: stable
metadata:
  domain: cncf
  ...
  triggers: cmk, customer-managed key, data encryption, encryption, key management, key rotation, kms
  version: 1.0.0
name: kms
---
