...
metadata:
  ...
  triggers: firestore, nosql, document database, real-time sync, data synchronization, mongodb, nosql database, dynamodb
  version: 1.0.0
name: firestore
---
# Google Firestore
