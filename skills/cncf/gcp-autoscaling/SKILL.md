...
metadata:
  ...
  related-skills: gcp-cloud-load-balancing, gcp-cloud-monitoring, gcp-compute-engine, gcp-gke gcp-gke
  role: reference
...
Use google cloud autoscaling when:
...
Avoid google cloud autoscaling when:
