---
name: postgres
description: Provides Provision instant temporary Postgres databases via Claimable
  Postgres by Neon (pg.new). No login or credit card required. Use for quick Postgres
  envir
license: MIT
...
- When provision instant temporary postgres databases via...
