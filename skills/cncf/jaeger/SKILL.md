...
- do-dont
- config
description: '"Configures jaeger in cloud-native engineering - distributed tracing for cloud-native deployment and infrastructure
  management."'
license: MIT
maturity: stable
metadata:
  ...
  triggers: cloud-native, distributed, distributed tracing, engineering, jaeger, tracing, request tracing, xray
  version: 1.0.0
name: jaeger
---
