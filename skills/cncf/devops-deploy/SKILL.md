---
name: deploy
description: '"Provides DevOps e deploy de aplicacoes — Docker, CI/CD com GitHub  Actions,
  AWS Lambda, SAM, Terraform, infraestrutura como codigo e monitoramento"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: devops deploy, devops, how do i deploy
---
...
- When devops e deploy de aplicacoes — docker, ci/cd com ...
