---
name: fintech
description: '"Provides Expert patterns for Plaid API integration including Link token
  flows, transactions sync, identity verification, Auth for ACH, balance checks, webhook"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: plaid fintech, api, integration, implementation guide
---
...
- When expert patterns for plaid api integration includin...
