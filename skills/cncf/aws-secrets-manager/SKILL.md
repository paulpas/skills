...
- do-dont
- config
description: '"Manages sensitive data with automatic encryption, rotation, and fine-grained" access control for database passwords,
...
metadata:
  ...
  triggers: credential rotation, password rotation, secret management, secrets manager, sensitive data
  version: 1.0.0
