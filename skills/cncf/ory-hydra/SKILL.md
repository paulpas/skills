...
metadata:
  ...
  triggers: ory hydra, ory-hydra, security, compliance, how do i find security issues, infrastructure as code, vulnerability
    scanning, monitoring
  version: 1.0.0
name: hydra
---
 # Ory-Hydra in Cloud-Native Engineering
...
**Primary Language:** Go  
**Documentation:** [https://github.com/ory/hydra](https://github.com/ory/hydra)  

---

## Purpose and Use Cases

Ory-Hydra is a cloud-native project that provides security functionality for modern distributed systems.

### What Problem Does It Solve?

Ory-Hydra addresses the challenges of security in cloud-native environments, enabling teams to implement security features without embedding them in application code.

### When to Use This Project

Use ory-hydra when you need security capabilities in your Kubernetes or cloud-native infrastructure. It's ideal when you require security with minimal application code changes.
