...
- do-dont
- config
description: '"Deploys managed NoSQL databases with DynamoDB for scalable, low-latency" key-value storage, streams, and global
  tables with high availability and automatic replication.'
license: MIT
maturity: stable
metadata:
  domain: cncf
