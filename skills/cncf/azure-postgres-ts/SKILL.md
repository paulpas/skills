---
name: postgres-ts
description: Provides Connect to Azure Database for PostgreSQL Flexible Server from
  Node.js/TypeScript using the pg (node-postgres) package
license: MIT
...
- When connect to azure database for postgresql flexible ...
