---
name: search
description: '"Provides Expert patterns for Algolia search implementation, indexing
...
metadata:
  ...
  output-format: code
  triggers: algolia search, api, integration, implementation guide
---
...
- When expert patterns for algolia search implementation,...
