---
name: patterns
description: '"Provides Common AWS CDK patterns and constructs for building cloud
  infrastructure with TypeScript, Python, or Java. Use when designing reusable CDK
  stacks and"'
license: MIT
