...
metadata:
  ...
  related-skills: azure-container-registry, azure-monitor, azure-resource-manager, azure-virtual-networks azure-traffic-manager
  role: reference
...
Use azure kubernetes service when:
...
Avoid azure kubernetes service when:
...
| Skill | Purpose |
|---|---|
| `cncf-azure-container-registry` | Related infrastructure service |
