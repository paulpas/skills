---
name: admin
description: '"Provides Expert database administrator specializing in modern cloud
...
metadata:
  ...
  output-format: code
  triggers: database admin, database, processing, how do i automate
---
...
- When expert database administrator specializing in mode...
