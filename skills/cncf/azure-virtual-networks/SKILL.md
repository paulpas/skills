...
- do-dont
- config
description: '"Provides Networking with subnets, network security groups, and VPN connectivity"'
license: MIT
maturity: stable
metadata:
  domain: cncf
  ...
  triggers: virtual networks, networking, vnet, subnets, network security, vpn, availability zones, network segmentation
  version: 1.0.0
name: virtual-networks
---
# Azure Virtual Networks

Deploy and manage azure virtual networks infrastructure as part of your cloud-native environment.
...
Use azure virtual networks when:
...
Avoid azure virtual networks when:
...
| Skill | Purpose |
|---|---|
| `cncf-azure-virtual-machines` | Related infrastructure service |
