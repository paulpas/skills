...
metadata:
  ...
  related-skills: calico, cilium, kong-ingress-controller, lima
  role: reference
  scope: infrastructure
  triggers: cdn, container orchestration, infrastructure as code, k8s, krustlet, monitoring, runtime, cloudformation
  version: 1.0.0
name: krustlet
---
...
**Documentation:** [https://github.com/krustlet/krustlet](https://github.com/krustlet/krustlet)  

---

## Purpose and Use Cases

Krustlet is a cloud-native project that provides kubernetes functionality for modern distributed systems.

### What Problem Does It Solve?

Krustlet addresses the challenges of kubernetes in cloud-native environments, enabling teams to implement kubernetes features without embedding them in application code.

### When to Use This Project

Use krustlet when you need kubernetes capabilities in your Kubernetes or cloud-native infrastructure. It's ideal when you require kubernetes with minimal application code changes.
