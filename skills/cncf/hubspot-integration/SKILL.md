---
name: integration
description: '"Provides Expert patterns for HubSpot CRM integration including OAuth
  authentication, CRM objects, associations, batch operations, webhooks, and custom
  objects"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: hubspot integration, api, integration, implementation guide
---
...
- When expert patterns for hubspot crm integration includ...
