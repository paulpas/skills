---
name: workflow
description: '"Provides Complete guide to implementing GitOps workflows with ArgoCD
  and Flux for automated Kubernetes deployments"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: gitops workflow, devops, how do i deploy
---
...
- When complete guide to implementing gitops workflows wi...
