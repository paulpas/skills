...
- do-dont
- config
description: '"Configures kubevela in cloud-native engineering - application platform for cloud-native deployment and infrastructure
  management."'
license: MIT
maturity: stable
metadata:
...
**Primary Language:** Go  
**Documentation:** [https://kubevela.io/](https://kubevela.io/)  

---

## Purpose and Use Cases

KubeVela is a application platform designed to help engineers build, deploy, and manage cloud-native applications.

### What Problem Does It Solve?

KubeVela addresses complex application-platform challenges by providing:
...
Use KubeVela when you need application platform, require application-platform-specific features, want to integrate with other CNCF projects, need production-ready application-platform solutions, or require application-platform-specific best practices.

### Key Use Cases

- **KubeVela Core**: Primary use case for application platform
...
- **Kubernetes**: Core platform for KubeVela
...
```yaml
# Example configuration for KubeVela
apiVersion: cncf.kubevela/v1
kind: Kubevela
metadata:
  name: example
  namespace: default
...
- **Resource**: Core abstraction managed by KubeVela
...
- **Official Documentation:** [https://kubevela.io/](https://kubevela.io/)
- **GitHub Repository:** [github.com/cncf/kubevela](https://github.com/cncf/kubevela)
- **CNCF Project Page:** [cncf.io/projects/kubevela/](https://www.cncf.io/projects/kubevela/)
