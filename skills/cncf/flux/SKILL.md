...
- do-dont
- config
description: '"Configures flux in cloud-native engineering - gitops for kubernetes for cloud-native deployment and infrastructure
  management."'
license: MIT
maturity: stable
metadata:
...
**Primary Language:** Go  
**Documentation:** [https://fluxcd.io/](https://fluxcd.io/)  
...
- **Official Documentation:** [https://fluxcd.io/](https://fluxcd.io/)
- **GitHub Repository:** [github.com/cncf/flux](https://github.com/cncf/flux)
- **CNCF Project Page:** [cncf.io/projects/flux/](https://www.cncf.io/projects/flux/)
