---
name: postgresql
description: Provides Design a PostgreSQL-specific schema. Covers best-practices,
  data types, indexing, constraints, performance patterns, and advanced features
license: MIT
...
- When design a postgresql-specific schema. covers best-p...
