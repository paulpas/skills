...
metadata:
  ...
  related-skills: gcp-cloud-load-balancing, gcp-cloud-monitoring, gcp-cloud-storage, gcp-compute-engine gcp-compute-engine
  role: reference
  scope: infrastructure
  triggers: cloud cdn, cdn, content delivery, caching, global distribution, cloudfront, elasticache, redis
  version: 1.0.0
name: cloud-cdn
---
# Google Cloud CDN
...
| Skill | Purpose |
|---|---|
| `cncf-gcp-cloud-storage` | Related infrastructure service |
