...
- do-dont
- config
description: '"Provides Emissary-Ingress in Cloud-Native Engineering - Kubernetes ingress controller"'
license: MIT
maturity: stable
metadata:
  domain: cncf
  ...
  triggers: cloud-native, emissary ingress, emissary-ingress, engineering, kubernetes ingress, container orchestration, ingress,
    http routing
  version: 1.0.0
name: ingress
---
...
**Primary Language:** Go  
**Documentation:** [https://www.emissary-ingress.io/](https://www.emissary-ingress.io/)  

---

## Purpose and Use Cases

Emissary-Ingress is a Kubernetes ingress controller designed to help engineers build, deploy, and manage cloud-native applications.

### What Problem Does It Solve?

Emissary-Ingress addresses complex networking challenges by providing:
...
Use Emissary-Ingress when you need Kubernetes ingress controller, require networking-specific features, want to integrate with other CNCF projects, need production-ready networking solutions, or require networking-specific best practices.

### Key Use Cases

- **Emissary-Ingress Core**: Primary use case for Kubernetes ingress controller
...
- **Kubernetes**: Core platform for Emissary-Ingress
...
```yaml
# Example configuration for Emissary-Ingress
apiVersion: cncf.emissary.ingress/v1
kind: EmissaryIngress
metadata:
  name: example
  namespace: default
spec:
...
- **Resource**: Core abstraction managed by Emissary-Ingress
...
- **Official Documentation:** [https://www.emissary-ingress.io/](https://www.emissary-ingress.io/)
- **GitHub Repository:** [github.com/cncf/emissary-ingress](https://github.com/cncf/emissary-ingress)
- **CNCF Project Page:** [cncf.io/projects/emissary-ingress/](https://www.cncf.io/projects/emissary-ingress/)
