...
- do-dont
- config
description: '"Configures harbor in cloud-native engineering - container registry for cloud-native deployment and infrastructure
  management."'
license: MIT
maturity: stable
metadata:
  ...
  triggers: cloud-native, container, engineering, harbor, container images, private registry, docker, containerization
  version: 1.0.0
name: harbor
---
...
**Primary Language:** Go  
**Documentation:** [https://goharbor.io/](https://goharbor.io/)  

---

## Purpose and Use Cases

Harbor is a container registry designed to help engineers build, deploy, and manage cloud-native applications.

### What Problem Does It Solve?

Harbor addresses complex registry challenges by providing:
...
Use Harbor when you need container registry, require registry-specific features, want to integrate with other CNCF projects, need production-ready registry solutions, or require registry-specific best practices.

### Key Use Cases

- **Harbor Core**: Primary use case for container registry
...
- **Kubernetes**: Core platform for Harbor
...
```yaml
# Example configuration for Harbor
apiVersion: cncf.harbor/v1
kind: Harbor
metadata:
  name: example
  namespace: default
...
- **Resource**: Core abstraction managed by Harbor
...
- **Official Documentation:** [https://goharbor.io/](https://goharbor.io/)
- **GitHub Repository:** [github.com/cncf/harbor](https://github.com/cncf/harbor)
- **CNCF Project Page:** [cncf.io/projects/harbor/](https://www.cncf.io/projects/harbor/)
