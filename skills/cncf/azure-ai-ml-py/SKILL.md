---
name: ai-ml-py
description: Provides Azure Machine Learning SDK v2 for Python. Use for ML workspaces,
  jobs, models, datasets, compute, and pipelines
license: MIT
...
- When azure machine learning sdk v2 for python. use for ...
