---
name: optimization
description: '"Provides Strategies and patterns for optimizing cloud costs across
  AWS, Azure, and GCP"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: cost optimization, cloud, implementation guide
---
...
- When strategies and patterns for optimizing cloud costs...
