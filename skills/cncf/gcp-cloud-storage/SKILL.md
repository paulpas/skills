...
- do-dont
- config
description: '"Provides Stores objects with versioning, lifecycle policies, access control, and integration with other GCP
  services"'
license: MIT
maturity: stable
metadata:
  ...
  triggers: cloud storage, gcs, object storage, bucket, versioning, storage lifecycle, how do i store files, s3
  version: 1.0.0
name: cloud-storage
---
...
Avoid google cloud storage when:
...
| Skill | Purpose |
|---|---|
| `cncf-gcp-cloud-cdn` | Related infrastructure service |
