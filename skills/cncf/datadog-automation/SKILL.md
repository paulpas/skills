---
name: automation
description: '''Provides Automate Datadog tasks via Rube MCP (Composio): query metrics,
  search logs, manage monitors/dashboards, create events and downtimes. Always search
  too'''
license: MIT
...
- When automate datadog tasks via rube mcp (composio): qu...
