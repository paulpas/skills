...
- do-dont
- config
description: '"Manages container image repositories with ECR for secure storage, scanning" replication, and integration with
  EKS, ECS, and Lambda for container deployments.'
license: MIT
maturity: stable
metadata:
  domain: cncf
  ...
  triggers: container registry, container security, containers, docker images, ecr, image repository, image scanning, vulnerability
    scanning
  version: 1.0.0
name: ecr
---
