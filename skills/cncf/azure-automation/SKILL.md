...
metadata:
  ...
  triggers: automation, runbooks, update management, orchestration, automation account, jenkins, ci/cd pipeline, continuous
    integration
  version: 1.0.0
name: automation
---
...
Deploy and manage azure automation infrastructure as part of your cloud-native environment.
