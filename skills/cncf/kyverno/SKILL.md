...
- do-dont
- config
description: '"Configures kyverno in cloud-native engineering - policy engine for cloud-native deployment and infrastructure
  management."'
license: MIT
maturity: stable
metadata:
  ...
  triggers: cloud-native, engineering, kyverno, policy, kubernetes policies, security policies, container orchestration, vulnerability
    scanning
  version: 1.0.0
name: kyverno
---
...
**Primary Language:** Go  
**Documentation:** [https://kyverno.io/](https://kyverno.io/)  

---

## Purpose and Use Cases

Kyverno is a policy engine designed to help engineers build, deploy, and manage cloud-native applications.

### What Problem Does It Solve?

Kyverno addresses complex policy challenges by providing:
...
Use Kyverno when you need policy engine, require policy-specific features, want to integrate with other CNCF projects, need production-ready policy solutions, or require policy-specific best practices.

### Key Use Cases

- **Kyverno Core**: Primary use case for policy engine
...
- **Kubernetes**: Core platform for Kyverno
...
```yaml
# Example configuration for Kyverno
apiVersion: cncf.kyverno/v1
kind: Kyverno
metadata:
  name: example
  namespace: default
...
- **Resource**: Core abstraction managed by Kyverno
...
- **GitHub Repository:** [github.com/cncf/kyverno](https://github.com/cncf/kyverno)
- **CNCF Project Page:** [cncf.io/projects/kyverno/](https://www.cncf.io/projects/kyverno/)
