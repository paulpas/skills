...
metadata:
  ...
  triggers: load balancer, load balancing, traffic distribution, health checks, routing, elb, route53, dns
  version: 1.0.0
name: load-balancer
---
# Azure Load Balancer
...
Avoid azure load balancer when:
...
| `cncf-azure-scale-sets` | Related infrastructure service |
