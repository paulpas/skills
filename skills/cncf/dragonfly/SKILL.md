...
- do-dont
- config
description: '"Provides Dragonfly in Cloud-Native Engineering - P2P file distribution"'
license: MIT
maturity: stable
metadata:
  domain: cncf
  ...
  triggers: cloud-native, distribution, dragonfly, engineering, elb, load balancer, load balancing
  version: 1.0.0
name: dragonfly
---
...
**Primary Language:** Go  
**Documentation:** [https://d7y.io/](https://d7y.io/)  

---

## Purpose and Use Cases

Dragonfly is a P2P file distribution designed to help engineers build, deploy, and manage cloud-native applications.

### What Problem Does It Solve?

Dragonfly addresses complex distribution challenges by providing:
...
Use Dragonfly when you need P2P file distribution, require distribution-specific features, want to integrate with other CNCF projects, need production-ready distribution solutions, or require distribution-specific best practices.

### Key Use Cases

- **Dragonfly Core**: Primary use case for P2P file distribution
...
- **Kubernetes**: Core platform for Dragonfly
...
```yaml
# Example configuration for Dragonfly
apiVersion: cncf.dragonfly/v1
kind: Dragonfly
metadata:
  name: example
  namespace: default
...
- **Resource**: Core abstraction managed by Dragonfly
...
- **Official Documentation:** [https://d7y.io/](https://d7y.io/)
- **GitHub Repository:** [github.com/cncf/dragonfly](https://github.com/cncf/dragonfly)
- **CNCF Project Page:** [cncf.io/projects/dragonfly/](https://www.cncf.io/projects/dragonfly/)
