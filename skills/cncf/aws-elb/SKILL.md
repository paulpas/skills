...
- do-dont
- config
description: '"Configures Elastic Load Balancing (ALB, NLB, Classic) for distributing" traffic across instances with health
  checks, SSL termination, and cross-AZ failover.'
license: MIT
maturity: stable
metadata:
  domain: cncf
  ...
  triggers: elb, load balancer, alb, nlb, application load balancer, health check, ssl termination, traffic distribution
  version: 1.0.0
name: elb
---
