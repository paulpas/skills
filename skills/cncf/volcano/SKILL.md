...
- do-dont
- config
description: '"Configures volcano in batch scheduling infrastructure for kubernetes for cloud-native deployment and infrastructure
  management."'
license: MIT
maturity: stable
metadata:
  ...
  triggers: batch, cloud infrastructure, infrastructure, scheduling, servers, volcano, ec2, virtual machines
  version: 1.0.0
name: volcano
---
