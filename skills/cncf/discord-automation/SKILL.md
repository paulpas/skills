---
name: automation
description: '''Provides Automate Discord tasks via Rube MCP (Composio): messages,
  channels, roles, webhooks, reactions. Always search tools first for current schemas'''
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: discord automation, api, integration, how do i automate
---
...
- When automate discord tasks via rube mcp (composio): me...
