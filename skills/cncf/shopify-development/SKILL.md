---
name: development
description: '"Provides Build Shopify apps, extensions, themes using GraphQL Admin
  API, Shopify CLI, Polaris UI, and Liquid"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: shopify development, api, integration, implementation guide
---
...
- When build shopify apps, extensions, themes using graph...
