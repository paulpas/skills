---
name: deployment
description: Provides Deploy containerized frontend + backend applications to Azure
  Container Apps with remote builds, managed identity, and idempotent infrastructure
license: MIT
...
- When deploy containerized frontend + backend applicatio...
