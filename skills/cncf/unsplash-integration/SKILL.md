---
name: integration
description: '"Provides Integration skill for searching and fetching high-quality,
  free-to-use professional photography from Unsplash"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: unsplash integration, api, integration, implementation guide
---
...
- When integration skill for searching and fetching high-...
