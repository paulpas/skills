...
- do-dont
- config
description: '"Deploys serverless event-driven applications with Lambda functions, triggers" layers, and VPC integration for
  cost-effective, auto-scaling compute without server management.'
license: MIT
maturity: stable
metadata:
  domain: cncf
