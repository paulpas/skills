...
- do-dont
- config
description: '"Provides Infrastructure as code using ARM templates for repeatable Azure resource deployments"'
license: MIT
maturity: stable
metadata:
  domain: cncf
  ...
  triggers: resource manager, arm templates, infrastructure as code, iac, deployment, cloudformation, kubernetes deployment,
    rolling updates
  version: 1.0.0
...
Use azure resource manager when:
...
Avoid azure resource manager when:
...
| `cncf-azure-virtual-networks` | Related infrastructure service |
