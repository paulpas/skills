...
metadata:
  ...
  triggers: deployment manager, infrastructure as code, iac, templates, yaml, cloudformation, kubernetes deployment, container
    orchestration
  version: 1.0.0
...
Deploy and manage google cloud deployment manager infrastructure as part of your cloud-native environment.
...
Use google cloud deployment manager when:
...
Avoid google cloud deployment manager when:
