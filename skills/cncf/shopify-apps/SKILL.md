---
name: apps
description: '"Provides Expert patterns for Shopify app development including Remix/React
  Router apps, embedded apps with App Bridge, webhook handling, GraphQL Admin API,
  Pol"'
license: MIT
...
metadata:
  ...
  output-format: code
  triggers: shopify apps, api, integration, implementation guide
---
...
- When expert patterns for shopify app development includ...
