...
- do-dont
- config
description: '"Configures kserve in cloud-native engineering - model serving for cloud-native deployment and infrastructure
  management."'
license: MIT
maturity: stable
metadata:
...
**Primary Language:** Go  
**Documentation:** [https://kserve.github.io/](https://kserve.github.io/)  

---

## Purpose and Use Cases

KServe is a model serving designed to help engineers build, deploy, and manage cloud-native applications.

### What Problem Does It Solve?

KServe addresses complex ml challenges by providing:
...
Use KServe when you need model serving, require ml-specific features, want to integrate with other CNCF projects, need production-ready ml solutions, or require ml-specific best practices.

### Key Use Cases

- **KServe Core**: Primary use case for model serving
...
- **Kubernetes**: Core platform for KServe
...
```yaml
# Example configuration for KServe
apiVersion: cncf.kserve/v1
kind: Kserve
metadata:
  name: example
  namespace: default
...
- **Resource**: Core abstraction managed by KServe
...
- **Official Documentation:** [https://kserve.github.io/](https://kserve.github.io/)
- **GitHub Repository:** [github.com/cncf/kserve](https://github.com/cncf/kserve)
- **CNCF Project Page:** [cncf.io/projects/kserve/](https://www.cncf.io/projects/kserve/)
