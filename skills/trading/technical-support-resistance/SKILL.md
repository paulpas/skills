...
- config
- do-dont
description: '"Implements technical levels where price tends to pause or reverse for risk management and algorithmic trading
  execution."'
license: MIT
maturity: stable
metadata:
  ...
  triggers: levels, price, technical support resistance, technical-support-resistance, where
  version: 1.0.0
