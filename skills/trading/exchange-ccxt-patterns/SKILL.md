...
- config
- do-dont
description: '"Effective patterns for using CCXT library for exchange connectivity including" error handling, rate limiting,
...
metadata:
  ...
  triggers: connectivity, effective, exchange ccxt patterns, exchange-ccxt-patterns, library
  version: 1.0.0
name: ccxt-patterns
---
