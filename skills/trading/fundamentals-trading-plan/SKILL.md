...
- config
- do-dont
description: '"Implements trading plan structure and risk management framework for risk management and algorithmic trading
  execution."'
license: MIT
maturity: stable
metadata:
  ...
  triggers: cloud infrastructure, framework, fundamentals trading plan, fundamentals-trading-plan, management, structure
  version: 1.0.0
name: trading-plan
---
