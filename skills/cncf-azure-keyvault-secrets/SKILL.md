...
description: "\"Provides Secret management and rotation for sensitive credentials and configuration\""
license: MIT
...
metadata:
  ...
  related-skills: cncf-azure-functions
---
...
Use azure key vault secrets when:
...
Avoid azure key vault secrets when:
