...
Keycloak is a identity and access management designed to help engineers build, deploy, and manage cloud-native applications.

### What Problem Does It Solve?

Keycloak addresses complex security challenges by providing:
...
Use Keycloak when you need identity and access management, require security-specific features, want to integrate with other CNCF projects, need production-ready security solutions, or require security-specific best practices.

### Key Use Cases

- **Keycloak Core**: Primary use case for identity and access management
...
- **Kubernetes**: Core platform for Keycloak
...
- **Resource**: Core abstraction managed by Keycloak
...
- **Official Documentation:** [https://www.keycloak.org/](https://www.keycloak.org/)
- **GitHub Repository:** [github.com/cncf/keycloak](https://github.com/cncf/keycloak)
- **CNCF Project Page:** [cncf.io/projects/keycloak/](https://www.cncf.io/projects/keycloak/)
...
The typical configuration pattern for cncf-keycloak follows standard CNCF practices:
