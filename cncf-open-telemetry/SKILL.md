...
**Primary Language:** Go  
**Documentation:** [https://github.com/open-telemetry/opentelemetry-collector](https://github.com/open-telemetry/opentelemetry-collector)  

---

## Purpose and Use Cases

Open-Telemetry is a cloud-native project that provides observability functionality for modern distributed systems.

### What Problem Does It Solve?

Open-Telemetry addresses the challenges of observability in cloud-native environments, enabling teams to implement observability features without embedding them in application code.

### When to Use This Project

Use open-telemetry when you need observability capabilities in your Kubernetes or cloud-native infrastructure. It's ideal when you require observability with minimal application code changes.
...
- observability with declarative configuration
- observability for observability and monitoring
- observability for security and compliance
...
The typical configuration pattern for cncf-open-telemetry follows standard CNCF practices:
...
kind: ConfigMap
metadata:
  name: cncf-open-telemetry-config
data:
