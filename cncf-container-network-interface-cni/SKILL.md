...
The typical configuration pattern for cncf-container-network-interface-cni follows standard CNCF practices:
...
kind: ConfigMap
metadata:
  name: cncf-container-network-interface-cni-config
data:
